    ...
    public function run($args)
    {
        $this->appOptions = array(
            ...
            'exclude' => array(
                ...
                '/components/TXFile',
                '/components/TXFsObject',
                '/components/TXObject',
                'DefaultController.php',
                'SiteController.php',
                'tcpdf',
                '/modules/Clasificator/extensions',
                '/modules/DtGenerator/extensions',
                '/modules/DtGenerator/components',
                '/modules/DtGenerator/helpers',
                '/modules/FileExplorer/extensions',
                '/modules/GraphvizTree/config',
                '/modules/ImportExport/config',
                '/modules/ImportExport/extensions',
                '/modules/Task/extensions/YiiMailer',
