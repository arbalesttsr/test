 ...
 */
(function ($) {
    if (typeof $.fn.each2 == "undefined")$.fn.extend({
        each2: function (c) {
...
(function ($, undefined) {
    ...
    function indexOf(value, array) {
        ...
        for (; i < l; i = i + 1)if (equal(value, array[i]))return i;
        return -1
    }
    ...
    function focus($el) {
        ...
        window.setTimeout(function () {
            ...
            $el.focus();
            if (el.setSelectionRange)el.setSelectionRange(pos, pos); else if (el.createTextRange) {
    ...
    function syncCssClasses(dest, src, adapter) {
        ...
        if (typeof classes === "string")$(classes.split(" ")).each2(function () {
        ...
        if (typeof classes === "string")$(classes.split(" ")).each2(function () {
            if (this.indexOf("select2-") !== 0) {
                ...
                if (typeof adapted === "string" && adapted.length > 0)replacements.push(this)
            }
        });
    ...
    function markMatch(text, term, markup, escapeMarkup) {
        var match =
            text.toUpperCase().indexOf(term.toUpperCase()), tl = term.length;
        if (match < 0) {
    ...
    function ajax(options) {
        ...
        return function (query) {
            ...
            timeout = window.setTimeout(function () {
                requestSequence += 1;
                var requestNumber = requestSequence, data = options.data, url = options.url, transport = options.transport || $.ajax, type = options.type || "GET", params = {};
    ...
    function local(options) {
        ...
        return function (query) {
            var t =
                query.term, filtered = {results: []}, process;
            if (t === "") {
    ...
    function tags(data) {
        ...
        return function (query) {
            ...
            $(isFunc ? data() : data).each(function () {
                ...
                if (t === "" || query.matcher(t, text))filtered.results.push(isObject ? this : {id: this, text: this})
            });
            query.callback(filtered)
        }
    }
    ...
    function defaultTokenizer(input, selection, selectCallback, opts) {
        ...
        if (!opts.createSearchChoice || !opts.tokenSeparators || opts.tokenSeparators.length <
            1)return undefined;
        while (true) {
            index = -1;
    ...
    AbstractSelect2 = clazz(Object, {
        bind: function (func) {
            ...
            var results, search,
                resultsSelector = ".select2-results", mask;
            this.opts = opts = this.prepareOpts(opts);
            this.id = opts.id;
            if (opts.element.data("select2") !== undefined && opts.element.data("select2") !== null)this.destroy();
            this.enabled = true;
            ...
            search.bind("keyup-change input paste",
            ...
            var element,
                select, idKey, ajaxUrl;
            element = opts.element;
            if (element.get(0).tagName.toLowerCase() === "select")this.select = select = opts.element;
            ...
            if (select) {
                opts.query = this.bind(function (query) {
                    var data =
                    {results: [], more: false}, term = query.term, children, firstChild, process;
                    process = function (element, collection) {
                        var group;
                        if (element.is("option")) {
                            if (query.matcher(term, element.text(), element))collection.push({
                            ...
                            element.children().each2(function (i,
                                                               elm) {
            ...
            el.bind("change.select2", this.bind(function (e) {
                if (this.opts.element.data("select2-change-triggered") !== true)this.initSelection()
            }));
            sync = this.bind(function () {
                var enabled, readonly, self = this;
                enabled = this.opts.element.attr("disabled") !==
                    "disabled";
                readonly = this.opts.element.attr("readonly") === "readonly";
                enabled = enabled && !readonly;
                if (this.enabled !== enabled)if (enabled)this.enable(); else this.disable();
                syncCssClasses(this.container, this.opts.element, this.opts.adaptContainerCssClass);
                this.container.addClass(evaluate(this.opts.containerCssClass));
                syncCssClasses(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass);
                this.dropdown.addClass(evaluate(this.opts.dropdownCssClass))
            });
            el.bind("propertychange.select2 DOMAttrModified.select2",
                sync);
        ...
        positionDropdown: function () {
            var offset = this.container.offset(), height = this.container.outerHeight(false), width = this.container.outerWidth(false), dropHeight = this.dropdown.outerHeight(false), viewPortRight = $(window).scrollLeft() + $(window).width(), viewportBottom = $(window).scrollTop() + $(window).height(), dropTop = offset.top + height, dropLeft = offset.left, enoughRoomBelow = dropTop + dropHeight <= viewportBottom, enoughRoomAbove = offset.top - dropHeight >= this.body().scrollTop(), dropWidth = this.dropdown.outerWidth(false),
                enoughRoomOnRight = dropLeft + dropWidth <= viewPortRight, aboveNow = this.dropdown.hasClass("select2-drop-above"), bodyOffset, above, css;
            ...
            if (mask.length == 0) {
                ...
                mask.bind("mousedown touchstart", function (e) {
                    ...
                    if (dropdown.length > 0) {
                        ...
                        if (self.opts.selectOnBlur)self.selectHighlighted({noFocus: true});
                        self.close()
                    }
                })
            }
            ...
            mask.css({width: document.documentElement.scrollWidth, height: document.documentElement.scrollHeight});
            mask.show();
            this.dropdown.show();
        ...
        clearSearch: function () {
            ...
            if (arguments.length === 0)return indexOf(choices.filter(".select2-highlighted")[0], choices.get());
            ...
            if (data)this.opts.element.trigger({type: "highlight", val: this.id(data), choice: data})
            ...
            } else if (el.length == 0)this.results.find(".select2-highlighted").removeClass("select2-highlighted")
            ...
            if (search.val().length < opts.minimumInputLength) {
                ...
                initial === true)render("<li class='select2-searching'>" + opts.formatSearching() + "</li>");
            ...
            input = this.tokenize();
            if (input != undefined && input != null)search.val(input);
            this.resultsPage = 1;
            opts.query({
                element: opts.element, term: search.val(),
                page: this.resultsPage, context: null, matcher: opts.matcher, callback: this.bind(function (data) {
                    var def;
                    if (!this.opened())return;
                    this.context = data.context === undefined ? null : data.context;
                    if (this.opts.createSearchChoice && search.val() !== "") {
                        def = this.opts.createSearchChoice.call(null, search.val(), data.results);
                        if (def !== undefined && def !== null && self.id(def) !== undefined && self.id(def) !== null)if ($(data.results).filter(function () {
                                return equal(self.id(this), self.id(def))
                            }).length === 0)data.results.unshift(def)
                    }
            ...
            var index =
                this.highlight(), highlighted = this.results.find(".select2-highlighted"), data = highlighted.closest(".select2-result").data("select2-data");
            if (data) {
                this.highlight(index);
            ...
            function resolveContainerWidth() {
                ...
                else if (this.opts.width === "element")return this.opts.element.outerWidth(false) === 0 ? "auto" : this.opts.element.outerWidth(false) + "px"; else if (this.opts.width === "copy" || this.opts.width === "resolve") {
            ...
            if (width !== null)this.container.css("width", width)
        }
    });
    SingleSelect2 = clazz(AbstractSelect2, {
        createContainer: function () {
            var container = $(document.createElement("div")).attr({"class": "select2-container"}).html(["<a href='javascript:void(0)' onclick='return false;' class='select2-choice' tabindex='-1'>",
            ...
            if (!this.enabled)return;
            this.parent.disable.apply(this,
                arguments);
            ...
            this.focusser =
                container.find(".select2-focusser");
            ...
            this.focusser.bind("keydown", this.bind(function (e) {
                if (!this.enabled)return;
                if (e.which === KEY.TAB ||
                    KEY.isControl(e) || KEY.isFunctionKey(e) || e.which === KEY.ESC)return;
            ...
            this.focusser.bind("keyup-change input", this.bind(function (e) {
                ...
                if (this.showSearchInput !==
                    false)this.search.val(this.focusser.val());
                this.focusser.val("");
                killEvent(e)
            }));
            ...
            selection.bind("mousedown", this.bind(function (e) {
                clickingInside = true;
                if (this.opened())this.close(); else if (this.enabled)this.open();
                killEvent(e);
            ...
            if (opts.element.get(0).tagName.toLowerCase() === "select")opts.initSelection = function (element, callback) {
            ...
            if (initial === true) {
                ...
                showSearchInput = min <
                0 ? false : countResults(data.results) >= min;
            ...
            if (this.opts.allowClear && this.getPlaceholder() !==
                undefined)this.selection.find("abbr").show()
        }, val: function () {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        createContainer: function () {
            var container = $(document.createElement("div")).attr({"class": "select2-container select2-container-multi"}).html(["    <ul class='select2-choices'>", "  <li class='select2-search-field'>", "    <input type='text' autocomplete='off' class='select2-input'>", "  </li>", "</ul>", "<div class='select2-drop select2-drop-multi' style='display:none;'>",
                "   <ul class='select2-results'>", "   </ul>", "</div>"].join(""));
            return container
        }, prepareOpts: function () {
            var opts = this.parent.prepareOpts.apply(this, arguments);
            if (opts.element.get(0).tagName.toLowerCase() === "select")opts.initSelection = function (element, callback) {
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                if (e.which === KEY.BACKSPACE && this.search.val() === "") {
                    ...
                    if (choices.length > 0)choices.last().addClass("select2-search-choice-focus")
                ...
                this.open();
                if (e.which === KEY.PAGE_UP ||
                    e.which === KEY.PAGE_DOWN)killEvent(e)
            }));
            ...
            if (this.opts.closeOnSelect) {
                ...
                this.search.width(10);
                this.resizeSearch();
                if (this.val().length >= this.getMaximumSelectionSize())this.updateResults(true);
                this.positionDropdown()
            } else {
                this.close();
                this.search.width(10)
            ...
            var enableChoice = !data.locked, enabledItem = $("<li class='select2-search-choice'>" + "    <div></div>" + "    <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'></a>" +
                "</li>"), disabledItem = $("<li class='select2-search-choice select2-locked'>" + "<div></div>" + "</li>");
            var choice = enableChoice ? enabledItem : disabledItem, id = this.id(data), val = this.getVal(), formatted;
            formatted = this.opts.formatSelection(data, choice.find("div"));
            if (formatted != undefined)choice.find("div").replaceWith("<div>" + this.opts.escapeMarkup(formatted) + "</div>");
            if (enableChoice)choice.find(".select2-search-choice-close").bind("mousedown", killEvent).bind("click dblclick", this.bind(function (e) {
                if (!this.enabled)return;
            ...
            if (selected.length === 0)throw"Invalid argument: " + selected + ". Must be .select2-search-choice";
        ...
        postprocessResults: function () {
            ...
            compound.each2(function (i, choice) {
                if (!choice.is(".select2-result-selectable") && choice.find(".select2-result-selectable:not(.select2-selected)").length ===
                    0)choice.addClass("select2-selected")
            });
            if (this.highlight() == -1)self.highlight(0)
            ...
            if (searchWidth <
                40)searchWidth = maxWidth - sideBorderPadding;
    ...
    $.fn.select2 = function () {
        ...
        this.each(function () {
            if (args.length === 0 || typeof args[0] === "object") {
                ...
                opts.element = $(this);
                if (opts.element.get(0).tagName.toLowerCase() === "select")multiple = opts.element.attr("multiple"); else {
                    multiple =
                        opts.multiple || false;
                ...
                if (args[0] === "container")value = select2.container; else value = select2[args[0]].apply(select2, args.slice(1));
                if (value !== undefined)return false
            } else throw"Invalid arguments to select2 plugin: " +
            args;
        });
    ...
    window.Select2 = {
        ...
        util: {debounce: debounce, markMatch: markMatch},
