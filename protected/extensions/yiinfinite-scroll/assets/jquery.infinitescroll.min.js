...
(function (a) {
    a.fn.infinitescroll = function (r, o) {
        ...
        function m() {
            k.loadingMsg.find("img").hide().parent().find("div").html(b.donetext).animate({opacity: 1}, 2000, function () {
        ...
        function i() {
            if (k.isDone) {
                ...
                if (t.length == 0 || t.hasClass("error404")) {
                    return a.event.trigger("ajaxError", [{status: 404}])
                }
                while (j[0].firstChild) {
                    p.appendChild(j[0].firstChild)
                }
                a(b.contentSelector)[0].appendChild(p);
                k.loadingMsg.fadeOut("normal");
                if (b.animate) {
        ...
        var b = a.extend({}, a.infinitescroll.defaults, r), k = a.infinitescroll, j, p;
        o = o || function () {
            };
        if (!h(b)) {
            return false
        ...
        var c = /(.*?\/\/).*?(\/.*)/, q = a(b.nextSelector).attr("href");
        if (!q) {
        ...
        k.loadingMsg = a('<div id="infscr-loading" style="text-align: center;"><img alt="Loading..." src="' + b.loadingImg + '" /><div>' + b.loadingText + "</div></div>");
