...
(function (e) {
    ...
    e.extend(e.fn.editableform.Constructor.prototype, {
        initButtons: function () {
            var t = this.$form.find(".editable-buttons");
            t.append(e.fn.editableform.buttons), this.options.showbuttons === "bottom" && t.addClass("editable-buttons-bottom"), this.$form.find(".editable-submit").button({
                icons: {primary: "ui-icon-check"},
                text: !1
            }).removeAttr("title"), this.$form.find(".editable-cancel").button({
                icons: {primary: "ui-icon-closethick"},
                text: !1
            }).removeAttr("title")
        }
    }), e.fn.editableform.errorGroupClass = null, e.fn.editableform.errorBlockClass = "ui-state-error"
}(window.jQuery), function (e) {
    "use strict";
    e.extend(e.fn.editableContainer.Popup.prototype, {
        ...
        splitOptions: function () {
            this.containerOptions = {}, this.formOptions = {};
            if (!e.ui[this.containerName]) {
                e.error('Please use jQueryUI with "tooltip" widget! http://jqueryui.com/download');
                return
            }
            var t = e.ui[this.containerName].prototype.options;
            for (var n in this.options)n in t ? this.containerOptions[n] = this.options[n] : this.formOptions[n] = this.options[n]
        },
        initContainer: function () {
        ...
        innerShow: function () {
            this.call("open");
            var t = this.options.title || this.$element.data("ui-tooltip-title") || this.$element.data("originalTitle");
            this.tip().find(this.innerCss).empty().append(e("<label>").text(t))
        },
        innerHide: function () {
            this.call("close")
        },
        ...
        setPosition: function () {
            this.tip().position(e.extend({of: this.$element}, this.containerOptions.position))
        },
        handlePlacement: function () {
            var e;
            switch (this.options.placement) {
                case"top":
                    e = {my: "center bottom-5", at: "center top", collision: "flipfit"};
                    break;
                case"right":
                    e = {my: "left+5 center", at: "right center", collision: "flipfit"};
                    break;
                case"bottom":
                    e = {my: "center top+5", at: "center bottom", collision: "flipfit"};
                    break;
                case"left":
                    e = {my: "right-5 center", at: "left center", collision: "flipfit"}
            }
            this.containerOptions.position = e
        }
    })
}(window.jQuery), function (e) {
    "use strict";
