...
class ElFinderHelper extends CComponent
{
    ...
    public static function registerAssets()
    {
        ...
        // elFinder JS
        if (YII_DEBUG) {
            $cs->registerScriptFile($assetsDir . '/js/elfinder.full.js', CClientScript::POS_END);
        } else {
            $cs->registerScriptFile($assetsDir . '/js/elfinder.min.js', CClientScript::POS_END);
        }
        ...
        if ($lang !== false)
            $cs->registerScriptFile($assetsDir . '/js/i18n/elfinder.' . $lang . '.js', CClientScript::POS_END);
