...
const ERROR_INVALID_NAME = 'errInvName';
    ...
    const ERROR_MOVE = 'errMove';
        const ERROR_COPY_FROM = 'errCopyFrom';     // 'File not found.'
        const ERROR_COPY_TO = 'errCopyTo'; // 'Target folder "$1" not found.'
    const ERROR_COPY_ITSELF = 'errCopyInItself';
const ERROR_REPLACE = 'errReplace';
const ERROR_RM = 'errRm';
    const ERROR_RM_SRC = 'errRmSrc';        // '"$1" is locked and can not be renamed, moved or removed.'
    const ERROR_UPLOAD = 'errUpload';        // 'File named "$1" already exists.'
    const ERROR_UPLOAD_FILE = 'errUploadFile';       // 'Invalid file name.'
...
const ERROR_NOT_REPLACE = 'errNotReplace';
    ...
    const ERROR_EXTRACT = 'errExtract';
        const ERROR_ARCHIVE = 'errArchive';          // 'Unable to replace "$1".'
        const ERROR_NOT_ARCHIVE = 'errNoArchive';               // 'Unable to remove "$1".'
        const ERROR_ARCHIVE_TYPE = 'errArcType';            // 'Unable remove source file(s)'
        const ERROR_ARC_SYMLINKS = 'errArcSymlinks';           // 'Upload error.'
        const ERROR_ARC_MAXSIZE = 'errArcMaxSize';       // 'Unable to upload "$1".'
        const ERROR_RESIZE = 'errResize';    // 'No files found for upload.'
        const ERROR_UNSUPPORT_TYPE = 'errUsupportType';  // 'Data exceeds the maximum allowed size.'
        const ERROR_NOT_UTF8_CONTENT = 'errNotUTF8Content';   // 'File exceeds maximum allowed size.'
        const ERROR_NETMOUNT = 'errNetMount';       // 'File type not allowed.'
        const ERROR_NETMOUNT_NO_DRIVER = 'errNetMountNoDriver';   // '"$1" transfer error.'
    // const ERROR_ACCESS_DENIED     = 'errAccess';
        const ERROR_NETMOUNT_FAILED = 'errNetMountFailed';       // Object "$1" already exists at this location and can not be replaced with object of another type.
