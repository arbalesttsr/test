...
!function (e) {
    window.elFinder = function (t, n) {
        this.time("load");
        var i, r, a, o = this, t = e(t), s = e("<div/>").append(t.contents()), l = t.attr("style"), d = t.attr("id") || "", c = "elfinder-" + (d || Math.random().toString().substr(2, 7)), p = "mousedown." + c, u = "keydown." + c, h = "keypress." + c, f = !0, m = !0, g = "", v = {
            path: "",
            url: "",
            tmbUrl: "",
            disabled: [],
            ...
            copyOverwrite: !0,
            tmb: !1
        }, b = {}, y = [], w = {}, x = {}, k = [], C = [], I = [], F = new o.command(o), T = "auto", z = 400, P = e(document.createElement("audio")).hide().appendTo("body")[0], A = function (t) {
            if (t.init)b = {}; else for (var n in b)b.hasOwnProperty(n) && "directory" != b[n].mime && b[n].phash == g && -1 === e.inArray(n, C) && delete b[n];
            g = t.cwd.hash, O(t.files), b[g] || O([t.cwd]), o.lastDir(g)
        }, O = function (e) {
            for (var t, n = e.length; n--;)if (t = e[n], t.name && t.hash && t.mime) {
                if (!t.phash) {
                    var i = "volume_" + t.name, r = o.i18n(i);
                    i != r && (t.i18 = r)
                }
                b[t.hash] = t
            }
        }, D = function (t) {
            var n = t.keyCode, i = !(!t.ctrlKey && !t.metaKey);
        ...
        return this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = -1 !== navigator.userAgent.indexOf("Mac") ? "mac" : -1 !== navigator.userAgent.indexOf("Win") ? "win" : "other", this.UA = function () {
            ...
            start: function (t, n) {
                ...
                for (i = a.length; i--;)if (r = a[i], b[r].locked) {
                    n.helper.addClass("elfinder-drag-helper-plus").data("locked", !0);
                    break
                }
            },
            stop: function () {
                o.trigger("focus").trigger("dragstop")
            },
            helper: function (t) {
                var n, i, r = this.id ? e(this) : e(this).parents("[id]:first"), a = e('<div class="elfinder-drag-helper"><span class="elfinder-drag-helper-icon-plus"/></div>'), s = function (e) {
                    return '<div class="elfinder-cwd-icon ' + o.mime2class(e) + ' ui-corner-all"/>'
                };
                return o.trigger("dragstart", {
                    target: r[0],
                    originalEvent: t
                }), n = r.is("." + o.res("class", "cwdfile")) ? o.selected() : [o.navId2Hash(r.attr("id"))], a.append(s(b[n[0]].mime)).data("files", n).data("locked", !1), (i = n.length) > 1 && a.append(s(b[n[i - 1]].mime) + '<span class="elfinder-drag-num">' + i + "</span>"), a
            }
        }, this.droppable = {
            tolerance: "pointer",
            ...
            drop: function (t, n) {
                var i, r, a, s = e(this), l = e.map(n.helper.data("files") || [], function (e) {
                    return e || null
                }), d = [], c = "class";
                ...
                d.length && (n.helper.hide(), o.clipboard(d, !(t.ctrlKey || t.shiftKey || t.metaKey || n.helper.data("locked"))), o.exec("paste", r), o.trigger("drop", {files: l}))
            }
            ...
            if (n)return n.hash;
            for (; t in b && b.hasOwnProperty(t);)if (n = b[t], !n.phash && "directory" == !n.mime && n.read)return n.hash;
            return ""
        }, this.cwd = function () {
            return b[g] || {}
            ...
            var n;
            for (n in b)if (b.hasOwnProperty(n) && b[n].phash == t && b[n].name == e)return b[n]
        }, this.validResponse = function (e, t) {
            return t.error || this.rules[this.rules[e] ? e : "defaults"](t)
        }, this.request = function (t) {
            var n, i, r, a = this, o = this.options, s = e.Deferred(), l = e.extend({}, o.customData, {mimes: o.onlyMimes}, t.data || t), d = l.cmd, c = !(t.preventDefault || t.preventFail), p = !(t.preventDefault || t.preventDone), u = e.extend({}, t.notify), h = !!t.raw, f = t.syncOnFail, t = e.extend({
                url: o.url,
                async: !0,
            ...
            if (f && s.fail(function (e) {
                    ...
                    clearTimeout(n)
                })), "open" == d)for (; r = I.pop();)"pending" == r.state() && (r.quiet = !0, r.abort());
            return delete t.preventFail, i = this.transport.send(t).fail(g).done(b), "open" == d && (I.unshift(i), s.always(function () {
                var t = e.inArray(i, I);
                -1 !== t && I.splice(t, 1)
            })), s
        }, this.diff = function (t) {
            var n = {}, i = [], r = [], a = [], o = function (e) {
                for (var t = a.length; t--;)if (a[t].hash == e)return !0
            };
            ...
            }), {added: i, removed: r, changed: a}
        }, this.sync = function () {
            var t = this, n = e.Deferred().done(function () {
                t.trigger("sync")
            }), i = {
                data: {cmd: "open", init: 1, target: g, tree: this.ui.tree ? 1 : 0},
                preventDefault: !0
            }, r = {data: {cmd: "tree", target: g == this.root() ? g : this.file(g).phash}, preventDefault: !0};
            return e.when(this.request(i), this.request(r)).fail(function (e) {
                n.reject(e), e && t.request({
                    data: {cmd: "open", target: t.lastDir(""), tree: 1, init: 1},
            ...
            var n;
            if ("function" == typeof t)for (e = ("" + e).toLowerCase().split(/\s+/), n = 0; n < e.length; n++)void 0 === w[e[n]] && (w[e[n]] = []), w[e[n]].push(t);
            return this
        }, this.unbind = function (e, t) {
            var n = w[("" + e).toLowerCase()] || [], i = n.indexOf(t);
            return i > -1 && n.splice(i, 1), t = null, this
        }, this.trigger = function (t, n) {
            var i, t = t.toLowerCase(), r = w[t] || [];
            if (this.debug("event-" + t, n), r.length)for (t = e.Event(t), i = 0; i < r.length; i++) {
                t.data = e.extend(!0, {}, n);
                try {
            ...
            var n, i, r, a, o;
            if (this.options.allowShortcuts && t.pattern && e.isFunction(t.callback))for (n = t.pattern.toUpperCase().split(/\s+/), a = 0; a < n.length; a++)i = n[a], o = i.split("+"), r = 1 == (r = o.pop()).length ? r > 0 ? r : r.charCodeAt(0) : e.ui.keyCode[r], r && !x[i] && (x[i] = {
                keyCode: r,
            ...
            return void 0 !== t && (k.length && this.trigger("unlockfiles", {files: i()}), C = [], k = e.map(t || [], function (e) {
                var t = b[e];
                return t ? (C.push(e), {
                    hash: e,
                    phash: t.phash,
            ...
            }), this.trigger("changeclipboard", {clipboard: k.slice(0, k.length)}), n && this.trigger("lockfiles", {files: i()})), k.slice(0, k.length)
            ...
            t && t[0].elfinder && (this.trigger("destroy").disable(), w = {}, x = {}, e(document).add(t).unbind("." + this.namespace), o.trigger = function () {
            }, t.children().remove(), t.append(s.contents()).removeClass(this.cssClass).attr("style", l), t[0].elfinder = null, i && clearInterval(i))
            ...
            var e = arguments[0];
            return 1 == arguments.length && "function" == typeof e ? o.bind("error", e) : o.trigger("error", {error: e})
            ...
            var t = P.canPlayType && P.canPlayType('audio/wav; codecs="1"');
            t && "" != t && "no" != t && e(P).html('<source src="./sounds/rm.wav" type="audio/wav">')[0].play()
            ...
            var i = o.commands[n];
            e.isFunction(i) && !o._commands[n] && (i.prototype = F, o._commands[n] = new i, o._commands[n].setup(n, o.options.commandsOptions[n] || {}))
            ...
            var r = "elfinder" + i, a = o.options.uiOptions[i] || {};
            !o.ui[i] && e.fn[r] && (o.ui[i] = e("<" + (a.tag || "div") + "/>").appendTo(t)[r](o, a))
        }), t[0].elfinder = this, this.options.resizable && e.fn.resizable && t.resizable({
            handles: "se",
            minWidth: 300,
            minHeight: 200
        }), this.options.width && (T = this.options.width), this.options.height && (z = parseInt(this.options.height)), o.resize(T, z), e(document).bind("click." + this.namespace, function (n) {
            ...
            n && !e.isEmptyObject(o.files()) && o.request({
                data: {cmd: "open", target: n, onhistory: 1},
                notify: {type: "open", cnt: 1, hideCnt: !0},
                syncOnFail: !0
            })
            ...
            }, preventDone: !0, notify: {type: "open", cnt: 1, hideCnt: !0}, freeze: !0
        }).fail(function () {
        ...
        }), void this.one("load", function () {
            t.trigger("resize"), o.options.sync > 1e3 && (i = setInterval(function () {
                o.sync()
            }, o.options.sync))
        })) : alert(this.i18n("errURL")) : alert(this.i18n("errNode")) : alert(this.i18n("errJqui"))
    }, elFinder.prototype = {
        res: function (e, t) {
        ...
        parseUploadData: function (t) {
            var n;
            if (!e.trim(t))return {error: ["errResponse", "errDataEmpty"]};
            try {
                n = e.parseJSON(t)
            } catch (i) {
        ...
        uploads: {
            iframe: function (t, n) {
                var i, r, a, o, s = n ? n : this, l = t.input, d = e.Deferred().fail(function (e) {
                    e && s.error(e)
                }).done(function (e) {
                    e.warning && s.error(e.warning), e.removed && s.remove(e), e.added && s.add(e), e.changed && s.change(e), s.trigger("upload", e), e.sync && s.sync()
                }), c = "iframe-" + s.namespace + ++s.iframeCnt, p = e('<form action="' + s.uploadURL + '" method="post" enctype="multipart/form-data" encoding="multipart/form-data" target="' + c + '" style="display:none"><input type="hidden" name="cmd" value="upload" /></form>'), u = this.UA.IE, h = function () {
                    ...
                    f.unbind("load").bind("load", function () {
                        ...
                        r = !0, s.notify({type: "upload", cnt: i})
                ...
                var i, r = n ? n : this, a = e.Deferred().fail(function (e) {
                    e && r.error(e)
                }).done(function (e) {
                    e.warning && r.error(e.warning), e.removed && r.remove(e), e.added && r.add(e), e.changed && r.change(e), r.trigger("upload", e), e.sync && r.sync()
                }).always(function () {
                    i && clearTimeout(i), p && r.notify({type: "upload", cnt: -d, progress: 100 * d})
                }), o = new XMLHttpRequest, s = new FormData, l = t.input ? t.input.files : t.files, d = l.length, c = 5, p = !1, u = function () {
                    return setTimeout(function () {
                        p = !0, r.notify({type: "upload", cnt: d, progress: c * d})
                ...
                return d ? (o.addEventListener("error", function () {
                    ...
                    var e, t = o.status;
                    return t > 500 ? a.reject("errResponse") : 200 != t ? a.reject("errConnect") : 4 != o.readyState ? a.reject(["errConnect", "errTimeout"]) : o.responseText ? (e = r.parseUploadData(o.responseText), void(e.error ? a.reject(e.error) : a.resolve(e))) : a.reject(["errResponse", "errDataEmpty"])
        ...
        cookie: function (t, n) {
            ...
            if (t = "elfinder-" + t + this.id, void 0 === n) {
                if (document.cookie && "" != document.cookie)for (a = document.cookie.split(";"), t += "=", o = 0; o < a.length; o++)if (a[o] = e.trim(a[o]), a[o].substring(0, t.length) == t)return decodeURIComponent(a[o].substring(t.length));
                return ""
            }
        ...
        _sortRules: {
            name: function (e, t) {
                ...
                var n = parseInt(e.size) || 0, i = parseInt(t.size) || 0;
                return n == i ? 0 : n > i ? 1 : -1
            }, kind: function (e, t) {
                return e.mime.localeCompare(t.mime)
            }, date: function (e, t) {
                var n = e.ts || e.date, i = t.ts || t.date;
                return n == i ? 0 : n > i ? 1 : -1
            }
        },
        compare: function (e, t) {
            var n, i = this, r = i.sortType, a = "asc" == i.sortOrder, o = i.sortStickFolders, s = i.sortRules, l = s[r], d = "directory" == e.mime, c = "directory" == t.mime;
            if (o) {
                if (d && !c)return -1;
                if (!d && c)return 1
            }
        ...
        notify: function (t) {
            ...
            return a ? (l.length || (l = e(d.replace(/\{type\}/g, a).replace(/\{msg\}/g, o)).appendTo(s).data("cnt", 0), p && l.data({
                ...
                progress: r,
                total: i
            }), s.find(".elfinder-notify-progress").animate({width: (100 > p ? p : 100) + "%"}, 20))) : (l.remove(), !s.children().length && s.elfinderdialog("close")), this) : this
        },
        confirm: function (t) {
            var n, i = !1, r = {
            ...
            return t.reject && (r.buttons[this.i18n(t.reject.label)] = function () {
                ...
                var t = e(this).next(), n = parseInt(t.children(":first").outerWidth() + t.children(":last").outerWidth());
        ...
        uniqueName: function (e, t) {
            ...
            for (; 1e4 > r;)if (i = e + " " + ++r + a, !this.fileByName(i, t))return i;
        ...
        i18n: function () {
            ...
            for (t = 0; t < arguments.length; t++)if (i = arguments[t], "string" == typeof i)o.push(l(i)); else if (e.isArray(i))for (n = 0; n < i.length; n++)"string" == typeof i[n] && o.push(l(i[n]));
            for (t = 0; t < o.length; t++)-1 === e.inArray(t, s) && (i = o[t], i = a[i] || i, i = i.replace(/\$(\d+)/g, function (e, n) {
                return n = t + parseInt(n), n > 0 && o[n] && s.push(n), o[n] || ""
            }), o[t] = i);
        ...
        formatDate: function (e, t) {
            var n, i, r, a, o, s, l, d, c, p, u, h = this, t = t || e.ts, f = h.i18;
    ...
    }, elFinder.prototype.version = "2.0.2", e.fn.elfinder = function (e) {
        ...
        commandsOptions: {
            ...
            quicklook: {autoplay: !0, jplayer: "extensions/jplayer"},
            edit: {mimes: [], editors: []},
            info: {nullUrlDirLinkSelf: !0},
        ...
        uiOptions: {
            toolbar: [["back", "forward"], ["netmount"], ["mkdir", "mkfile", "upload"], ["open", "download", "getfile"], ["info"], ["quicklook"], ["copy", "cut", "paste"], ["rm"], ["duplicate", "rename", "edit", "resize"], ["extract", "archive"], ["search"], ["view", "sort"], ["help"]],
            tree: {openRootOnLoad: !0, syncTree: !0},
            navbar: {minWidth: 150, maxWidth: 500},
            cwd: {oldSchool: !1}
        },
        onlyMimes: [],
        sortRules: {},
        ...
        }, s = t.options.useBrowserHistory && window.history && window.history.pushState ? window.history : null, l = function (s) {
        ...
        this.canBack = function () {
            ...
            var e = a.length, i = t.cwd().hash;
            r && (n >= 0 && e > n + 1 && a.splice(n + 1), a[a.length - 1] != i && a.push(i), n = a.length - 1), r = !0, s && (s.state ? s.state.thash != i && s.pushState({thash: i}, null, location.pathname + location.search + "#elf_" + i) : s.replaceState({thash: i}, null, location.pathname + location.search + "#elf_" + i))
        }).reload(o)
        ...
        this.fm = t, this.name = "", this.title = "", this.state = -1, this.alwaysEnabled = !1, this._disabled = !1, this.disableOnSearch = !1, this.updateOnSelect = !0, this._handlers = {
        ...
        }, this.handlers = {}, this.shortcuts = [], this.options = {ui: "button"}, this.setup = function (t, n) {
            var i, r, a = this, o = this.fm;
            ...
            var n = this.state, i = this.value;
            this.state = this._disabled ? -1 : void 0 !== e ? e : this.getstate(), this.value = t, (n != this.state || i != this.value) && this.change()
        }, this.change = function (e) {
            var t, n;
            if ("function" == typeof e)this.listeners.push(e); else for (n = 0; n < this.listeners.length; n++) {
                t = this.listeners[n];
                try {
        ...
        mimes: {text: ["application/x-empty", "application/javascript", "application/xhtml+xml", "audio/x-mp3-playlist", "application/x-web-config", "application/docbook+xml", "application/x-php", "application/x-perl", "application/x-awk", "application/x-config", "application/x-csh", "application/xml"]},
        mixin: {
            make: function () {
                ...
                }), a = "tmp_" + parseInt(1e5 * Math.random()), o = t.cwd().hash, s = new Date, l = {
                    hash: a,
        ...
        var n = "elfinderPosition", i = "elfinderDestroyOnClose";
        if (this.not(".elfinder").each(function () {
                {
                    var r = (e(document), e('<div class="ui-widget-header dialogelfinder-drag ui-corner-top">' + (t.title || "Files") + "</div>")), a = (e('<a href="#" class="dialogelfinder-drag-close ui-corner-all"><span class="ui-icon ui-icon-closethick"/></a>').appendTo(r).click(function (e) {
                ...
                a.width(parseInt(a.width()) || 840).data(i, !!t.destroyOnClose).find(".elfinder-toolbar").removeClass("ui-corner-top"), t.position && a.data(n, t.position), t.autoOpen !== !1 && e(this).dialogelfinder("open")
            }), "open" == t) {
            var r = e(this), a = r.data(n) || {
        ...
        return this.each(function () {
            var n, i = "class", r = t.fm, a = r.res(i, "disabled"), o = r.res(i, "active"), s = r.res(i, "hover"), l = "elfinder-button-menu-item", d = "elfinder-button-menu-item-selected", c = e(this).addClass("ui-state-default elfinder-button").attr("title", t.title).append('<span class="elfinder-button-icon elfinder-button-icon-' + t.name + '"/>').hover(function (e) {
        ...
        return this.each(function () {
            var n = e(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + t.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "mouseenter mouseleave", function () {
            ...
            }), i = "ltr" == t.direction ? "left" : "right", r = e.extend({}, t.options.contextmenu), a = '<div class="elfinder-contextmenu-item"><span class="elfinder-button-icon {icon} elfinder-contextmenu-icon"/><span>{label}</span></div>', o = function (t, n, i) {
                return e(a.replace("{icon}", n ? "elfinder-button-icon-" + n : "").replace("{label}", t)).click(function (e) {
                    e.stopPropagation(), e.stopPropagation(), i()
                })
            }, s = function (r, a) {
                var o = e(window), s = n.outerWidth(), l = n.outerHeight(), d = o.width(), c = o.height(), p = o.scrollTop(), u = o.scrollLeft(), h = {
                    top: (c > a + l ? a : a - l > 0 ? a - l : a) + p,
                    left: (d > r + s ? r : r - s) + u,
                    "z-index": 100 + t.getUI("workzone").zIndex()
                };
                n.css(h).show(), h = {"z-index": h["z-index"] + 10}, h[i] = parseInt(n.width()), n.find(".elfinder-contextmenu-sub").css(h)
            }, l = function () {
                n.hide().empty()
            }, d = function (i, a) {
                var s = !1;
                e.each(r[i] || [], function (i, r) {
                    var d, c, p;
                    if ("|" == r && s)return n.append('<div class="elfinder-contextmenu-separator"/>'), void(s = !1);
                    if (d = t.command(r), d && -1 != d.getstate(a)) {
                        if (d.variants) {
                            if (!d.variants.length)return;
                            c = o(d.title, d.name, function () {
                            }), p = e('<div class="ui-corner-all elfinder-contextmenu-sub"/>').appendTo(c.append('<span class="elfinder-contextmenu-arrow"/>')), c.addClass("elfinder-contextmenu-group").hover(function () {
                                p.toggle()
                            }), e.each(d.variants, function (t, n) {
                                p.append(e('<div class="elfinder-contextmenu-item"><span>' + n[1] + "</span></div>").click(function (e) {
        ...
        return this.not(".elfinder-cwd").each(function () {
            var i = "list" == t.viewType, r = "select." + t.namespace, a = "unselect." + t.namespace, o = "disable." + t.namespace, s = "enable." + t.namespace, l = "class", d = t.res(l, "cwdfile"), c = "." + d, p = "ui-selected", u = t.res(l, "disabled"), h = t.res(l, "draggable"), f = t.res(l, "droppable"), m = t.res(l, "hover"), g = t.res(l, "adroppable"), v = d + "-tmp", b = t.options.loadTmbs > 0 ? t.options.loadTmbs : 5, y = "", w = [], x = {
            ...
            }, k = t.res("tpl", "perms"), C = t.res("tpl", "symlink"), I = {
                ...
                var s, l, d, c, h, f = e.ui.keyCode, m = t == f.LEFT || t == f.UP, g = K.find("[id]." + p);
                if (g.length)if (s = g.filter(m ? ":first" : ":last"), d = o(s, m ? "prev" : "next"), d.length)if (i || t == f.LEFT || t == f.RIGHT)l = d; else if (c = s.position().top, h = s.position().left, l = s, m) {
                    ...
                    l.is("." + u) && (l = o(l, "prev")), l.length || (d = K.find("[id]:not(." + u + "):last"), d.position().top > c && (l = d))
                } else l = s; else l = K.find("[id]:not(." + u + "):not(.elfinder-cwd-parent):" + (m ? "last" : "first"));
                ...
                var n = t.cwd().hash;
                K.find("[id]:not(." + p + "):not(.elfinder-cwd-parent)").trigger(r), P = e.map(t.files(), function (e) {
                    return e.phash == n ? e.hash : null
                }), M()
            }, D = function () {
                P = [], K.find("[id]." + p).trigger(a), M()
            }, M = function () {
                t.trigger("select", {selected: P})
            }, S = function (e) {
                var t = e.position().top, n = e.outerHeight(!0), i = G.scrollTop(), r = G.innerHeight();
                t + n > i + r ? G.scrollTop(parseInt(t + n - r)) : i > t && G.scrollTop(t)
            }, E = [], j = function (e) {
                for (var t = E.length; t--;)if (E[t].hash == e)return t;
                return -1
            }, U = "scroll." + t.namespace, R = function () {
                var n, a = [], o = !1, s = [], l = {}, d = K.find("[id]:last"), c = !d.length, u = i ? K.children("table").children("tbody") : K;
                if (!E.length)return G.unbind(U);
                for (; (!d.length || d.position().top <= G.height() + G.scrollTop() + t.options.showThreshold) && (n = E.splice(0, t.options.showFiles)).length;)a = e.map(n, function (e) {
                    return e.hash && e.name ? ("directory" == e.mime && (o = !0), e.tmb && (1 === e.tmb ? s.push(e.hash) : l[e.hash] = e.tmb), F(e)) : null
                }), u.append(a.join("")), d = K.find("[id]:last"), c && K.scrollTop(0);
                L(l), s.length && N(s), o && H(), P.length && u.find("[id]:not(." + p + "):not(.elfinder-cwd-parent)").each(function () {
                    var t = this.id;
                    -1 !== e.inArray(t, P) && e(this).trigger(r)
                })
            }, q = e.extend({}, t.droppable, {
                over: function (n, i) {
                    var r = t.cwd().hash;
                    e.each(i.helper.data("files"), function (e, n) {
                        return t.file(n).phash == r ? (K.removeClass(g), !1) : void 0
                    })
                }
            }), H = function () {
                setTimeout(function () {
                    K.find(".directory:not(." + f + ",.elfinder-na,.elfinder-ro)").droppable(t.droppable)
                }, 20)
            }, L = function (n) {
                var i, r = t.option("tmbUrl"), a = !0;
                return e.each(n, function (t, n) {
                    ...
                    }(o, r + n) : (a = !1, -1 != (i = j(t)) && (E[i].tmb = n))
                }), a
            }, N = function (e) {
                var n = [];
                return t.oldAPI ? void t.request({
                    data: {cmd: "tmb", current: t.cwd().hash},
                    preventFail: !0
                }).done(function (e) {
                    L(e.images || []) && e.tmb && N()
                }) : (n = n = e.splice(0, b), void(n.length && t.request({
                    data: {cmd: "tmb", targets: n},
                    preventFail: !0
                }).done(function (t) {
                    L(t.images || []) && N(e)
                })))
            }, _ = function (e) {
                for (var n, r, a, o, s = i ? K.find("tbody") : K, l = e.length, d = [], c = {}, p = !1, u = function (e) {
                    for (var n, i = K.find("[id]:first"); i.length;) {
                        if (n = t.file(i.attr("id")), !i.is(".elfinder-cwd-parent") && n && t.compare(e, n) < 0)return i;
                        i = i.next("[id]")
                    }
                }, h = function (e) {
                    var n, i = E.length;
                    for (n = 0; i > n; n++)if (t.compare(e, E[n]) < 0)return n;
                    return i || -1
                }; l--;)n = e[l], r = n.hash, K.find("#" + r).length || ((a = u(n)) && a.length ? a.before(F(n)) : (o = h(n)) >= 0 ? E.splice(o, 0, n) : s.append(F(n)), K.find("#" + r).length && ("directory" == n.mime ? p = !0 : n.tmb && (1 === n.tmb ? d.push(r) : c[r] = n.tmb)));
                L(c), d.length && N(d), p && H()
            }, V = function (e) {
                for (var n, i, r, a = e.length; a--;)if (n = e[a], (i = K.find("#" + n)).length)try {
                    i.detach()
                } catch (o) {
                    t.debug("error", o)
                } else-1 != (r = j(n)) && E.splice(r, 1)
            }, W = {
                name: t.i18n("name"),
                perm: t.i18n("perms"),
                mod: t.i18n("modify"),
                ...
                D();
                try {
                    K.children("table," + c).remove()
                } catch (s) {
                    K.html("")
                }
                if (K.removeClass("elfinder-cwd-view-icons elfinder-cwd-view-list").addClass("elfinder-cwd-view-" + (i ? "list" : "icons")), G[i ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list"), i && K.html('<table><thead><tr class="ui-state-default"><td >' + W.name + "</td><td>" + W.perm + "</td><td>" + W.mod + "</td><td>" + W.size + "</td><td>" + W.kind + "</td></tr></thead><tbody/></table>"), E = e.map(r, function (e) {
                        return a || e.phash == o ? e : null
                    }), E = t.sortFiles(E), G.bind(U, R).trigger(U), o = t.cwd().phash, n.oldSchool && o && !y) {
                    var l = e.extend(!0, {}, t.file(o), {name: "..", mime: "directory"});
                    l = e(F(l)).addClass("elfinder-cwd-parent").bind("mousedown click mouseup touchstart touchmove touchend dblclick mouseenter", function (e) {
                        e.preventDefault(), e.stopPropagation()
                    }).dblclick(function () {
                        t.exec("open", this.id)
                    }), (i ? K.find("tbody") : K).prepend(l)
                }
            }, K = e(this).addClass("ui-helper-clearfix elfinder-cwd").attr("unselectable", "on").delegate(c, "click." + t.namespace, function (n) {
                var i, o = this.id ? e(this) : e(this).parents("[id]:first"), s = o.prevAll("." + p + ":first"), l = o.nextAll("." + p + ":first"), d = s.length, c = l.length;
                n.stopImmediatePropagation(), n.shiftKey && (d || c) ? (i = d ? o.prevUntil("#" + s.attr("id")) : o.nextUntil("#" + l.attr("id")), i.add(o).trigger(r)) : n.ctrlKey || n.metaKey ? o.trigger(o.is("." + p) ? a : r) : e(this).data("touching") && o.is("." + p) ? (e(this).data("touching", null), t.dblclick({file: this.id}), D()) : (D(), o.trigger(r)), M()
            }).delegate(c, "dblclick." + t.namespace, function () {
                t.dblclick({file: this.id})
            }).delegate(c, "touchstart." + t.namespace, function () {
                e(this).data("touching", !0);
                var t = this.id ? e(this) : e(this).parents("[id]:first"), n = t.prevAll("." + p + ":first").length + t.nextAll("." + p + ":first").length;
                e(this).data("longtap", setTimeout(function () {
                    t.trigger(t.is("." + p) ? a : r), M(), 0 == n && t.is("." + p) && (t.trigger("click"), M())
                }, 500))
            }).delegate(c, "touchmove." + t.namespace + " touchend." + t.namespace, function () {
                clearTimeout(e(this).data("longtap"))
            }).delegate(c, "mouseenter." + t.namespace, function () {
                var n = e(this), r = i ? n : n.children();
                n.is("." + v) || r.is("." + h + ",." + u) || r.draggable(t.draggable)
            }).delegate(c, r, function () {
                var t = e(this), n = t.attr("id");
                T || t.is("." + u) || (t.addClass(p).children().addClass(m), -1 === e.inArray(n, P) && P.push(n))
            }).delegate(c, a, function () {
                var t, n = e(this), i = n.attr("id");
                T || (e(this).removeClass(p).children().removeClass(m), t = e.inArray(i, P), -1 !== t && P.splice(t, 1))
            }).delegate(c, o, function () {
                var t = e(this).removeClass(p).addClass(u), n = (i ? t : t.children()).removeClass(m);
                t.is("." + f) && t.droppable("disable"), n.is("." + h) && n.draggable("disable"), !i && n.removeClass(u)
            }).delegate(c, s, function () {
                var t = e(this).removeClass(u), n = i ? t : t.children();
                ...
                t.trigger("hover", {hash: e(this).attr("id"), type: n.type}), e(this).toggleClass("ui-state-hover")
            }).bind("contextmenu." + t.namespace, function (n) {
                var i = e(n.target).closest("." + d);
                i.length && (n.stopPropagation(), n.preventDefault(), i.is("." + u) || (i.is("." + p) || (D(), i.trigger(r), M()), t.trigger("contextmenu", {
                    type: "files",
                    targets: t.selected(),
                    x: n.clientX,
                    y: n.clientY
                ...
                !e.shiftKey && !e.ctrlKey && !e.metaKey && D()
            }).selectable({
                filter: c, stop: M, delay: 250, selected: function (t, n) {
                    e(n.selected).trigger(r)
                }, unselected: function (t, n) {
                    e(n.unselected).trigger(a)
                }
            }).droppable(q).bind("create." + t.namespace, function (t, n) {
                var r = i ? K.find("tbody") : K, a = r.find(".elfinder-cwd-parent"), n = e(F(n)).addClass(v);
                D(), a.length ? a.after(n) : r.prepend(n), K.scrollTop(0)
            }).bind("unselectall", D).bind("selectfile", function (e, t) {
                K.find("#" + t).trigger(r), M()
            }), G = e('<div class="elfinder-cwd-wrapper"/>').bind("contextmenu", function (e) {
                ...
                var t = 0;
                G.siblings(".elfinder-panel:visible").each(function () {
                    t += e(this).outerHeight(!0)
                }), G.height(X.height() - t)
            }, J = e(this).parent().resize($), X = J.children(".elfinder-workzone").append(G.append(this));
            t.dragUpload && (G[0].addEventListener("dragenter", function (e) {
                e.preventDefault(), e.stopPropagation(), G.addClass(g)
            }, !1), G[0].addEventListener("dragleave", function (e) {
                e.preventDefault(), e.stopPropagation(), e.target == K[0] && G.removeClass(g)
            }, !1), G[0].addEventListener("dragover", function (e) {
                e.preventDefault(), e.stopPropagation()
            }, !1), G[0].addEventListener("drop", function (e) {
                e.preventDefault(), G.removeClass(g), e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length && t.exec("upload", {files: e.dataTransfer.files})
            }, !1)), t.bind("open", function (e) {
                B(e.data.files)
            }).bind("search", function (e) {
                w = e.data.files, B(w, !0)
                ...
                var n = t.selected(), r = "list" == t.storage("view");
                r != i && (i = r, B(t.files()), e.each(n, function (e, t) {
                    A(t)
                }), M()), $()
            }).add(function (n) {
                ...
                var i = t.cwd().hash, r = t.selected();
                y ? e.each(n.data.changed || [], function (t, n) {
                    V([n.hash]), -1 !== n.name.indexOf(y) && (_([n]), -1 !== e.inArray(n.hash, r) && A(n.hash))
                }) : e.each(e.map(n.data.changed || [], function (e) {
                    return e.phash == i ? e : null
                }), function (t, n) {
                    V([n.hash]), _([n]), -1 !== e.inArray(n.hash, r) && A(n.hash)
                }), M()
            }).remove(function (e) {
                V(e.data.removed || []), M()
            }).bind("open add search searchend", function () {
                K.css("height", "auto"), K.outerHeight(!0) < G.height() && K.height(G.height() - (K.outerHeight(!0) - K.height()) - 2)
            }).dragstart(function (t) {
                var n = e(t.data.target), i = t.data.originalEvent;
                n.is(c) && (n.is("." + p) || (!(i.ctrlKey || i.metaKey || i.shiftKey) && D(), n.trigger(r), M()), K.droppable("disable")), K.selectable("disable").removeClass(u), T = !0
            }).dragstop(function () {
                K.selectable("enable").droppable("enable"), T = !1
            }).bind("lockfiles unlockfiles", function (e) {
                for (var t = "lockfiles" == e.type ? o : s, n = e.data.files || [], i = n.length; i--;)K.find("#" + n[i]).trigger(t);
                M()
                ...
                type: "keydown",
                callback: function (e) {
                    z(e.keyCode, e.shiftKey)
                }
            }).shortcut({
                pattern: "home", description: "selectffile", callback: function () {
                    D(), S(K.find("[id]:first").trigger(r)), M()
                }
            }).shortcut({
                pattern: "end", description: "selectlfile", callback: function () {
                    D(), S(K.find("[id]:last").trigger(r)), M()
                }
            })
        }), this
        ...
        return "string" == typeof t && (n = this.closest(".ui-dialog")).length && ("open" == t ? "none" == n.css("display") && n.fadeIn(120, function () {
            ...
            var n, i = e(this).addClass("ui-dialog-content ui-widget-content"), r = i.parent(), a = "elfinder-dialog-active", o = "elfinder-dialog", s = "elfinder-dialog-notify", l = "ui-state-hover", d = parseInt(1e6 * Math.random()), c = r.children(".elfinder-overlay"), p = e('<div class="ui-dialog-buttonset"/>'), u = e('<div class=" ui-helper-clearfix ui-dialog-buttonpane ui-widget-content"/>').append(p), h = e('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' + o + " " + t.cssClass + '"/>').hide().append(i).appendTo(r).draggable({
                handle: ".ui-dialog-titlebar",
                containment: "document"
            }).css({width: t.width, height: t.height}).mousedown(function (t) {
                ...
                h.trigger("totop"), "function" == typeof t.open && e.proxy(t.open, i[0])(), h.is("." + s) || r.find("." + o + ":visible").not("." + s).each(function () {
                    var t = e(this), n = parseInt(t.css("top")), i = parseInt(t.css("left")), r = parseInt(h.css("top")), a = parseInt(h.css("left"));
                    t[0] == h[0] || n != r && i != a || h.css({top: n + 10 + "px", left: i + 10 + "px"})
                })
            }).bind("close", function () {
                var n = r.find(".elfinder-dialog:visible"), a = f();
        ...
        return this.not(".elfinder-navbar").each(function () {
            var i, r = e(this).addClass("ui-state-default elfinder-navbar"), a = r.parent().resize(function () {
                r.height(o.height() - s)
            }), o = a.children(".elfinder-workzone").append(r), s = r.outerHeight() - r.height(), l = "ltr" == t.direction;
        ...
        if (this.filter(":not(.elfinder-overlay)").each(function () {
            ...
            var n = this.eq(0), i = n.data("cnt") + 1, r = n.data("show");
            n.data("cnt", i), n.is(":hidden") && (n.zIndex(n.parent().zIndex() + 1), n.show(), r())
        }
        if ("hide" == t) {
            var n = this.eq(0), i = n.data("cnt") - 1, a = n.data("hide");
            n.data("cnt", i), 0 == i && n.is(":visible") && (n.hide(), a())
        }
        return this
    }, e.fn.elfinderpanel = function (t) {
        return this.each(function () {
            var n = e(this).addClass("elfinder-panel ui-state-default ui-corner-all"), i = "margin-" + ("ltr" == t.direction ? "left" : "right");
            t.one("load", function () {
        ...
        return this.each(function () {
            var i = [], r = "class", a = t.res(r, "navdir"), o = t.res(r, "navcollapse"), s = t.res(r, "navexpand"), l = (t.res(r, "hover"), t.res(r, "treeroot")), d = t.res("tpl", "navdir"), c = t.res("tpl", "perms"), p = e(t.res("tpl", "navspinner")), u = function (e) {
                return e.substr(6)
            }, h = function (e) {
                return "place-" + e
            }, f = function () {
                ...
                w.children().length && e.each(w.children(), function () {
                    ...
                    stop: function (t, n) {
                        var i = x.offset().top, r = x.offset().left, a = x.width(), o = x.height(), s = t.clientX, l = t.clientY;
                        s > r && r + a > s && l > i && l + o > l ? e(this).show() : (v(n.helper.data("hash")), f())
                    }
                })
            }, v = function (t) {
                var n = e.inArray(t, i);
                -1 !== n && (i.splice(n, 1), w.find("#" + h(t)).parent().remove(), !w.children().length && y.removeClass(o + " " + s))
            }, b = m({
            ...
            }), w = b.children("." + t.res(r, "navsubtree")), x = e(this).addClass(t.res(r, "tree") + " elfinder-places ui-corner-all").hide().append(b).appendTo(t.getUI("navbar")).delegate("." + a, "hover", function () {
                e(this).toggleClass("ui-state-hover")
        ...
        return this.each(function () {
            ...
            e('<span class="ui-icon ui-icon-search" title="' + t.title + '"/>').appendTo(i).click(r), e('<span class="ui-icon ui-icon-close"/>').appendTo(i).click(a), setTimeout(function () {
                if (i.parent().detach(), t.fm.getUI("toolbar").prepend(i.show()), t.fm.UA.ltIE7) {
                    ...
                    e.css({right: "", left: parseInt(i.width()) - e.outerWidth(!0)})
                }
        ...
        return this.each(function () {
            ...
            e.each(n.sortRules, function (t) {
                ...
                t.exec([], {type: n.sortType, order: n.sortOrder, stick: !n.sortStickFolders})
        ...
        return this.each(function () {
            ...
            t.getUI("statusbar").prepend(n).append(i).show(), t.bind("open reload add remove change searchend", function () {
                ...
                var n = 0, a = 0, s = t.selectedFiles();
                return 1 == s.length ? (n = s[0].size, void i.html(t.escape(s[0].name) + (n > 0 ? ", " + t.formatSize(n) : ""))) : (e.each(s, function (e, t) {
                    a++, n += parseInt(t.size) || 0
                }), void i.html(a ? o + ": " + a + ", " + r + ": " + t.formatSize(n) : "&nbsp;"))
            })
        })
    }, e.fn.elfindertoolbar = function (t, n) {
        return this.not(".elfinder-toolbar").each(function () {
            var i, r, a, o, s = t._commands, l = e(this).addClass("ui-helper-clearfix ui-widget-header ui-corner-top elfinder-toolbar"), d = n || [], c = d.length;
            for (l.prev().length && l.parent().prepend(this); c--;)if (d[c]) {
        ...
        return this.not("." + i).each(function () {
            var r = "class", a = t.res(r, "treeroot"), o = n.openRootOnLoad, s = t.res(r, "navsubtree"), l = t.res(r, "treedir"), d = t.res(r, "navcollapse"), c = t.res(r, "navexpand"), p = "elfinder-subtree-loaded", u = t.res(r, "navarrow"), h = t.res(r, "active"), f = t.res(r, "adroppable"), m = t.res(r, "hover"), g = t.res(r, "disabled"), v = t.res(r, "draggable"), b = t.res(r, "droppable"), y = function (e) {
                var t = U.offset().left;
                return e >= t && e <= t + U.width()
            }, w = t.droppable.drop, x = e.extend(!0, {}, t.droppable, {
                over: function (t) {
                    var n = e(this), i = m + " " + f;
                ...
                return e ? j.find("#" + t.navHash2Id(e)).next("." + s) : j
            }, O = function (n, i) {
                ...
                for (var n, i, r, a, o = e.length, s = [], l = e.length, d = !0; l--;)n = e[l], j.find("#" + t.navHash2Id(n.hash)).length || ((r = A(n.phash)).length ? (i = z(n), n.phash && (a = O(r, n)).length ? a.before(i) : (r[d || n.phash ? "append" : "prepend"](i), d = !1)) : s.push(n));
                return s.length && s.length < o ? D(s) : void setTimeout(function () {
                    S()
                }, 10)
            }, M = function () {
                var e, i, r = t.cwd().hash, d = j.find("#" + t.navHash2Id(r));
                if (o && (e = j.find("#" + t.navHash2Id(t.root())), e.is("." + p) && e.addClass(c).next("." + s).show(), o = !1), d.is("." + h) || (j.find("." + l + "." + h).removeClass(h), d.addClass(h)), n.syncTree) {
                    if (d.length)return d.parentsUntil("." + a).filter("." + s).show().prev("." + l).addClass(c);
                    if (t.newAPI) {
                        if (i = t.file(r), i && i.phash && j.find("#" + t.navHash2Id(i.phash)).length)return D([i]), M();
                        t.request({data: {cmd: "parents", target: r}, preventFail: !0}).done(function (e) {
                            var n = P(e.tree);
                ...
                j.find("." + l + ":not(." + b + ",.elfinder-ro,.elfinder-na)").droppable(x)
            }, E = function (n, i) {
                var r = i == p ? "." + d + ":not(." + p + ")" : ":not(." + d + ")";
                e.each(n, function (n, a) {
                    j.find("#" + t.navHash2Id(a.phash) + r).filter(function () {
                        return e(this).next("." + s).children().length > 0
                    }).addClass(i)
                })
            }, j = e(this).addClass(i).delegate("." + l, "hover", function (n) {
                var i = e(this), r = "mouseenter" == n.type;
                ...
                n.stopPropagation(), r.is("." + p) ? (r.toggleClass(c), a.slideToggle()) : (k.insertBefore(i), r.removeClass(d), t.request({
                    ...
                    D(P(e.tree)), a.children().length && (r.addClass(d + " " + c), a.slideDown()), M()
                }).always(function () {
            ...
            }), U = t.getUI("navbar").append(j).show();
            t.open(function (e) {
                var t = e.data, n = P(t.files);
                t.init && j.empty(), n.length && (D(n), E(n, p)), M()
            }).add(function (e) {
                var t = P(e.data.added);
                t.length && (D(t), E(t, d))
            }).change(function (n) {
                for (var i, r, a, o, d, u, h, f, m, g = P(n.data.changed), v = g.length; v--;)if (i = g[v], (r = j.find("#" + t.navHash2Id(i.hash))).length) {
                    if (i.phash) {
                    ...
                    f = r.is("." + c), m = r.is("." + p), a = e(z(i)), r.replaceWith(a.children("." + l)), i.dirs && (f || m) && (r = j.find("#" + t.navHash2Id(i.hash))) && r.next("." + s).children().length && (f && r.addClass(c), m && r.addClass(p))
                }
                M(), S()
            }).remove(function (e) {
                for (var n, i, r = e.data.removed, a = r.length; a--;)(n = j.find("#" + t.navHash2Id(r[a]))).length && (i = n.closest("." + s), n.parent().detach(), i.children().length || i.hide().prev("." + l).removeClass(d + " " + c + " " + p))
            }).bind("search searchend", function (e) {
                j.find("#" + t.navHash2Id(t.cwd().hash))["search" == e.type ? "removeClass" : "addClass"](h)
                ...
                e.each(a, function (e, n) {
                    var a = j.find("#" + t.navHash2Id(n));
                    a.length && (a.is("." + v) && a.draggable(r), a.is("." + b) && a.droppable(h), a[i ? "addClass" : "removeClass"](g))
                })
            })
        }), this
    }, e.fn.elfinderuploadbutton = function (t) {
        return this.each(function () {
            var n = e(this).elfinderbutton(t).unbind("click"), i = e("<form/>").appendTo(n), r = e('<input type="file" multiple="true"/>').change(function () {
                var n = e(this);
                n.val() && (t.exec({input: n.remove()[0]}), r.clone(!0).appendTo(i))
            });
        ...
        return this.each(function () {
            var n = e(this).elfinderbutton(t), i = n.children(".elfinder-button-icon");
            t.change(function () {
                var e = "icons" == t.value;
        ...
        return this.not("." + t).each(function () {
            var n = e(this).addClass(t), i = n.outerHeight(!0) - n.height(), r = n.parent();
            r.add(window).bind("resize", function () {
                var a = r.height();
                r.children(":visible:not(." + t + ")").each(function () {
                    var t = e(this);
                    "absolute" != t.css("position") && (a -= t.outerHeight(!0))
                }), n.height(a - i)
            })
        }), this
        ...
        this.variants = [], this.disableOnSearch = !0, n.bind("open reload", function () {
            ...
            var a, o = this.files(t), s = o.length, l = r || i[0], d = n.cwd(), c = ["errArchive", "errPerm", "errCreatingTempDir", "errFtpDownloadFile", "errFtpUploadFile", "errFtpMkdir", "errArchiveExec", "errExtractExec", "errRm"], p = e.Deferred().fail(function (e) {
                e && n.error(e)
            });
            if (!(this.enabled() && s && i.length && -1 !== e.inArray(l, i)))return p.reject();
            if (!d.write)return p.reject(c);
            for (a = 0; s > a; a++)if (!o[a].read)return p.reject(c);
            return n.request({
                data: {cmd: "archive", targets: this.hashes(t), type: l},
        ...
        this.shortcuts = [{pattern: "ctrl+c ctrl+insert"}], this.getstate = function (t) {
            var t = this.files(t), n = t.length;
        ...
        this.shortcuts = [{pattern: "ctrl+x shift+insert"}], this.getstate = function (t) {
            var t = this.files(t), n = t.length;
            return n && e.map(t, function (e) {
        ...
        this.shortcuts = [{pattern: "shift+enter"}], this.getstate = function () {
            var e = this.fm.selected(), t = e.length;
            return this._disabled || !t || n.UA.IE && 1 != t || t != i(e).length ? -1 : 0
        }, this.exec = function (t) {
            var n, r = this.fm, a = r.options.url, o = i(t), s = e.Deferred(), l = "", d = "";
            ...
            }), r.trigger("download", {files: o}), s.resolve(t)
        }
    }, elFinder.prototype.commands.duplicate = function () {
        var t = this.fm;
        this.getstate = function (n) {
            var n = this.files(n), i = n.length;
            ...
            return !r || this._disabled ? a.reject() : (e.each(i, function (e, t) {
                ...
                data: {cmd: "duplicate", targets: this.hashes(t)},
                notify: {type: "copy", cnt: r}
            }))
        }
        ...
        var t = this, n = this.fm, i = n.res("mimes", "text") || [], r = function (n) {
            ...
            var o = e.Deferred(), s = e('<textarea class="elfinder-file-edit" rows="20" id="' + i + '-ta">' + n.escape(a) + "</textarea>"), l = function () {
                ...
                title: r.name, width: t.options.dialogWidth || 450, buttons: {}, close: function () {
                    s.editor && s.editor.close(s[0], s.editor.instance), e(this).elfinderdialog("destroy")
                }, open: function () {
                    n.disable(), s.focus(), s[0].setSelectionRange && s[0].setSelectionRange(0, 0), s.editor && s.editor.load(s[0])
                }
            };
            ...
            var i, r = t.hash, o = (n.options, e.Deferred()), s = (n.url(r) || n.options.url, "edit-" + n.namespace + "-" + t.hash), l = n.getUI().find("#" + s);
            return l.length ? (l.elfinderdialog("toTop"), o.resolve()) : t.read && t.write ? (n.request({
                data: {
                    cmd: "get",
                    target: r
                }, notify: {type: "openfile", cnt: 1}, syncOnFail: !0
            }).done(function (e) {
                a(s, t, e.content).done(function (e) {
                    n.request({
                        options: {type: "post"},
                        data: {cmd: "put", target: r, content: e},
        ...
        this.shortcuts = [{pattern: "ctrl+e"}], this.init = function () {
            ...
            var e = this.files(e), t = e.length;
            return !this._disabled && t && r(e).length == t ? 0 : -1
        }, this.exec = function (t) {
            var n, i = r(this.files(t)), a = [];
        ...
        var t = this, n = t.fm, i = [], r = function (t) {
        ...
        this.disableOnSearch = !0, n.bind("open reload", function () {
            ...
            var r, a, o, s = this.files(t), l = e.Deferred(), d = s.length, c = !1, p = !1, u = e.map(n.files(t), function (e) {
                return e.name
            }), h = {};
            ...
            var f = function (e) {
                ...
                t.read && n.file(t.phash).write ? -1 === e.inArray(t.mime, i) ? (a = ["errExtract", t.name, "errNoArchive"], n.error(a), l.reject(a)) : n.request({
                    data: {
                        cmd: "extract",
                        target: t.hash
                    }, notify: {type: "extract", cnt: 1}, syncOnFail: !0
                }).fail(function (e) {
                    "rejected" != l.state() && l.reject(e)
                }).done(function () {
                }) : (a = ["errExtract", t.name, "errPerm"], n.error(a), l.reject(a))
            }, g = function (t, i) {
                var a = t[i], s = a.name.replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/gi, ""), v = e.inArray(s, u) >= 0;
        ...
        this.alwaysEnabled = !0, this.callback = n.options.getFileCallback, this._disabled = "function" == typeof this.callback, this.getstate = function (e) {
            ...
            var i, r, a, o = this.fm, s = this.options, l = this.files(n), d = l.length, c = o.option("url"), p = o.option("tmbUrl"), u = e.Deferred().done(function (e) {
                o.trigger("getfile", {files: e}), t.callback(e, o), "close" == s.oncomplete ? o.hide() : "destroy" == s.oncomplete && o.destroy()
            }), h = function () {
            ...
            for (i = 0; d > i; i++) {
                ...
                r.baseUrl = c, r.url = o.url(r.hash), r.path = o.path(r.hash), r.tmb && 1 != r.tmb && (r.tmb = p + r.tmb), r.width || r.height || (r.dim ? (a = r.dim.split("x"), r.width = a[0], r.height = a[1]) : -1 !== r.mime.indexOf("image") && f.push(o.request({
                    data: {
                        cmd: "dim",
                        target: r.hash
                    }, notify: {type: "dim", cnt: 1, hideCnt: !0}, preventDefault: !0
                }).done(function (e) {
                    if (e.dim) {
                        var t = e.dim.split("x"), n = o.file(this.hash);
        ...
        var t, n = this.fm, i = this, r = '<div class="elfinder-help-link"> <a href="{url}" target="_blank">{link}</a></div>', a = '<div class="elfinder-help-team"><div>{author}</div>{work}</div>', o = /\{url\}/, s = /\{link\}/, l = /\{author\}/, d = /\{work\}/, c = "replace", p = "ui-priority-primary", u = "ui-priority-secondary", h = "elfinder-help-license", f = '<li class="ui-state-default ui-corner-top"><a href="#{id}">{title}</a></li>', m = ['<div class="ui-tabs ui-widget ui-widget-content ui-corner-all elfinder-help">', '<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">'], g = '<div class="elfinder-help-shortcut"><div class="elfinder-help-shortcut-pattern">{pattern}</div> {descrip}</div>', v = '<div class="elfinder-help-separator"/>', b = function () {
            m.push('<div id="about" class="ui-tabs-panel ui-widget-content ui-corner-bottom"><div class="elfinder-help-logo"/>'), m.push("<h3>elFinder</h3>"), m.push('<div class="' + p + '">' + n.i18n("webfm") + "</div>"), m.push('<div class="' + u + '">' + n.i18n("ver") + ": " + n.version + ", " + n.i18n("protocolver") + ': <span id="apiver"></span></div>'), m.push('<div class="' + u + '">jQuery/jQuery UI: ' + e().jquery + "/" + e.ui.version + "</div>"), m.push(v), m.push(r[c](o, "http://elfinder.org/")[c](s, n.i18n("homepage"))), m.push(r[c](o, "https://github.com/Studio-42/elFinder/wiki")[c](s, n.i18n("docs"))), m.push(r[c](o, "https://github.com/Studio-42/elFinder")[c](s, n.i18n("github"))), m.push(r[c](o, "http://twitter.com/elrte_elfinder")[c](s, n.i18n("twitter"))), m.push(v), m.push('<div class="' + p + '">' + n.i18n("team") + "</div>"), m.push(a[c](l, 'Dmitry "dio" Levashov &lt;dio@std42.ru&gt;')[c](d, n.i18n("chiefdev"))), m.push(a[c](l, "Troex Nevelin &lt;troex@fury.scancode.ru&gt;")[c](d, n.i18n("maintainer"))), m.push(a[c](l, "Alexey Sukhotin &lt;strogg@yandex.ru&gt;")[c](d, n.i18n("contributor"))), m.push(a[c](l, "Naoki Sawada &lt;hypweb@gmail.com&gt;")[c](d, n.i18n("contributor"))), n.i18[n.lang].translator && m.push(a[c](l, n.i18[n.lang].translator)[c](d, n.i18n("translator") + " (" + n.i18[n.lang].language + ")")), m.push(v), m.push('<div class="' + h + '">' + n.i18n("icons") + ': Pixelmixer, <a href="http://p.yusukekamiyamane.com" target="_blank">Fugue</a></div>'), m.push(v), m.push('<div class="' + h + '">Licence: BSD Licence</div>'), m.push('<div class="' + h + '">Copyright © 2009-2011, Studio 42</div>'), m.push('<div class="' + h + '">„ …' + n.i18n("dontforget") + " ”</div>"), m.push("</div>")
        }, y = function () {
            var t = n.shortcuts();
            m.push('<div id="shortcuts" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), t.length ? (m.push('<div class="ui-widget-content elfinder-help-shortcuts">'), e.each(t, function (e, t) {
                m.push(g.replace(/\{pattern\}/, t[0]).replace(/\{descrip\}/, t[1]))
            }), m.push("</div>")) : m.push('<div class="elfinder-help-disabled">' + n.i18n("shortcutsof") + "</div>"), m.push("</div>")
        }, w = function () {
            m.push('<div id="help" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), m.push('<a href="http://elfinder.org/forum/" target="_blank" class="elfinder-dont-panic"><span>DON\'T PANIC</span></a>'), m.push("</div>")
        };
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [{
            pattern: "f1",
            description: this.title
        }], setTimeout(function () {
            var r = i.options.view || ["about", "shortcuts", "help"];
            e.each(r, function (e, t) {
                m.push(f[c](/\{id\}/, t)[c](/\{title\}/, n.i18n(t)))
            }), m.push("</ul>"), -1 !== e.inArray("about", r) && b(), -1 !== e.inArray("shortcuts", r) && y(), -1 !== e.inArray("help", r) && w(), m.push("</div>"), t = e(m.join("")), n.one("load", function () {
                t.find("#apiver").text(n.api)
            }), t.find(".ui-tabs-nav li").hover(function () {
                e(this).toggleClass("ui-state-hover")
            }).children().click(function (n) {
                var i = e(this);
                n.preventDefault(), n.stopPropagation(), i.is(".ui-tabs-selected") || (i.parent().addClass("ui-tabs-selected ui-state-active").siblings().removeClass("ui-tabs-selected").removeClass("ui-state-active"), t.find(".ui-tabs-panel").hide().filter(i.attr("href")).show())
            }).filter(":first").click()
        ...
        this.title = "Home", this.alwaysEnabled = !0, this.updateOnSelect = !1, this.shortcuts = [{
            ...
            var e = this.fm.root(), t = this.fm.cwd().hash;
            return e && t && e != t ? 0 : -1
        }, this.exec = function () {
        ...
        this.tpl = {
        ...
        }, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.shortcuts = [{pattern: "ctrl+i"}], this.init = function () {
            ...
            var a, o, s, l, d, c = this.fm, p = this.options, u = this.tpl, h = u.row, f = r.length, m = [], g = u.main, v = "{label}", b = "{value}", y = {
                title: this.title,
                width: "auto",
                close: function () {
            ...
            if (1 == f) {
                if (s = r[0], g = g.replace("{class}", c.mime2class(s.mime)), l = u.itemTitle.replace("{name}", c.escape(s.i18 || s.name)).replace("{kind}", c.mime2kind(s)), s.tmb && (o = c.option("tmbUrl") + s.tmb), s.read ? "directory" != s.mime || s.alias ? a = c.formatSize(s.size) : (a = u.spinner.replace("{text}", i.calc), w.push(s.hash)) : a = i.unknown, m.push(h.replace(v, i.size).replace(b, a)), s.alias && m.push(h.replace(v, i.aliasfor).replace(b, s.alias)), m.push(h.replace(v, i.path).replace(b, c.escape(c.path(s.hash, !0)))), s.read) {
                    ...
                    if (p.nullUrlDirLinkSelf && "directory" == s.mime && null === s.url) {
                        ...
                        I = F.pathname + F.search + "#elf_" + s.hash
                    } else I = c.url(s.hash);
                    m.push(h.replace(v, i.link).replace(b, '<a href="' + I + '" target="_blank">' + s.name + "</a>"))
                }
                s.dim ? m.push(h.replace(v, i.dim).replace(b, s.dim)) : -1 !== s.mime.indexOf("image") && (s.width && s.height ? m.push(h.replace(v, i.dim).replace(b, s.width + "x" + s.height)) : (m.push(h.replace(v, i.dim).replace(b, u.spinner.replace("{text}", i.calc))), c.request({
                    ...
                    if (x(e.dim || i.unknown), e.dim) {
                        var t = e.dim.split("x"), n = c.file(s.hash);
        ...
        this.disableOnSearch = !0, this.updateOnSelect = !1, this.mime = "directory", this.prefix = "untitled folder", this.exec = e.proxy(this.fm.res("mixin", "make"), this), this.shortcuts = [{pattern: "ctrl+shift+n"}], this.getstate = function () {
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {
            ...
            var n = t.fm, i = e.Deferred(), r = function () {
                var r = {
                    protocol: e("<select/>"),
                ...
                return e.each(t.drivers, function (e, t) {
                    ...
                    return e.each(r, function (t, i) {
                        var r = e.trim(i.val());
                        r && (n[t] = r)
                    }), n.host ? (t.fm.request({data: n, notify: {type: "netmount", cnt: 1}}).done(function () {
                        i.resolve()
                    }).fail(function (e) {
                        i.reject(e)
                    }), void t.dialog.elfinderdialog("close")) : t.fm.trigger("error", {error: "errNetMountHostReq"})
        ...
        this.alwaysEnabled = !0, this._handlers = {
        ...
        }, this.shortcuts = [{pattern: "ctrl+down numpad_enter" + ("mac" != this.fm.OS && " enter")}], this.getstate = function (t) {
            var t = this.files(t), n = t.length;
            return 1 == n ? 0 : n && e.map(t, function (e) {
                return "directory" == e.mime ? null : e
            }).length == n ? 0 : -1
        }, this.exec = function (t) {
            var n, i, r, a, o = this.fm, s = e.Deferred().fail(function (e) {
                e && o.error(e)
            }), l = this.files(t), d = l.length;
            ...
            for (d = l.length; d--;) {
                ...
                var u = e.extend({}, o.options.customData, {cmd: "file", target: n.hash});
        ...
        this.updateOnSelect = !1, this.handlers = {
        ...
        }, this.shortcuts = [{pattern: "ctrl+v shift+insert"}], this.getstate = function (t) {
            ...
            var n, i, r = this, a = r.fm, t = t ? this.files(t)[0] : a.cwd(), o = a.clipboard(), s = o.length, l = s ? o[0].cut : !1, d = l ? "errMove" : "errCopy", c = [], p = [], u = e.Deferred().fail(function (e) {
                e && a.error(e)
            }), h = function (t) {
                return t.length && a._commands.duplicate ? a.exec("duplicate", t) : e.Deferred().resolve()
            }, f = function (n) {
                var i = e.Deferred(), o = [], s = function (t, n) {
                    for (var i = [], r = t.length; r--;)-1 !== e.inArray(t[r].name, n) && i.unshift(r);
                    return i
                }, d = function (e) {
                    var t = o[e], r = n[t], s = e == o.length - 1;
                    r && a.confirm({
                        title: a.i18n(l ? "moveFiles" : "copyFiles"),
                        text: a.i18n(["errExists", r.name, "confirmRepl"]),
                        all: !s,
                        accept: {
                        ...
                        reject: {
                            label: "btnNo", callback: function (t) {
                                var i;
                                if (t)for (i = o.length; e < i--;)n[o[i]].remove = !0; else n[o[e]].remove = !0;
                                s || t ? p(n) : d(++e)
                            }
                        },
                        cancel: {
                    ...
                    return o ? (r = n[0].phash, n = e.map(n, function (e) {
                        ...
                        data: {cmd: "paste", dst: t.hash, targets: n, cut: l ? 1 : 0, src: r},
                        notify: {type: l ? "move" : "copy", cnt: o}
                    }).always(function () {
                        i.resolve(), a.unlockfiles({files: n})
                    })) : i.resolve()
                };
            ...
            return s && t && "directory" == t.mime ? t.write ? (n = a.parents(t.hash), e.each(o, function (r, s) {
                ...
                }).length ? !u.reject(["errReplByChild", s.name]) : void(s.phash == t.hash ? p.push(s.hash) : c.push({
                    hash: s.hash,
                    phash: s.phash,
                    name: s.name
                }))) : !u.reject([d, o[0].name, "errPerm"])
            }), "rejected" == u.state() ? u : e.when(h(p), f(c)).always(function () {
                l && a.clipboard([])
            })) : u.reject([d, o[0].name, "errPerm"]) : u.reject()
        }
    }, elFinder.prototype.commands.quicklook = function () {
        var t, n, i, r, a = this, o = a.fm, s = 0, l = 1, d = 2, c = s, p = "elfinder-quicklook-navbar-icon", u = "elfinder-quicklook-fullscreen", h = function (t) {
            e(document).trigger(e.Event("keydown", {keyCode: t, ctrlKey: !1, shiftKey: !1, altKey: !1, metaKey: !1}))
        }, f = function (e) {
            return {
                opacity: 0,
                width: 20,
            ...
            var t = document.createElement(e.substr(0, e.indexOf("/"))), n = !1;
            try {
                n = t.canPlayType && t.canPlayType(e)
            } catch (i) {
            }
            return n && "" !== n && "no" != n
        }, v = e('<div class="elfinder-quicklook-title"/>'), b = e("<div/>"), y = e('<div class="elfinder-quicklook-info"/>'), w = e('<div class="' + p + " " + p + '-fullscreen"/>').mousedown(function (t) {
            var n = a.window, r = n.is("." + u), s = "scroll." + o.namespace, l = e(window);
            t.stopPropagation(), r ? (n.css(n.data("position")).unbind("mousemove"), l.unbind(s).trigger(a.resize).unbind(a.resize), x.unbind("mouseenter").unbind("mousemove")) : (n.data("position", {
                ...
                width: n.width(),
                height: n.height()
            }).css({width: "100%", height: "100%"}), e(window).bind(s, function () {
                n.css({left: parseInt(e(window).scrollLeft()) + "px", top: parseInt(e(window).scrollTop()) + "px"})
                ...
                e.stopPropagation()
            })), x.attr("style", "").draggable(r ? "destroy" : {}), n.toggleClass(u), e(this).toggleClass(p + "-fullscreen-off"), e.fn.resizable && i.add(n).resizable(r ? "enable" : "disable").removeClass("ui-state-disabled")
        ...
        this.resize = "resize." + o.namespace, this.info = e('<div class="elfinder-quicklook-info-wrapper"/>').append(b).append(y), this.preview = e('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change", function () {
            ...
            var n, i = a.fm, r = (a.preview, t.file), o = '<div class="elfinder-quicklook-info-data">{value}</div>';
        ...
        }))).append(this.preview.add(x)).append(a.info.hide()).draggable({handle: "div.elfinder-quicklook-titlebar"}).bind("open", function () {
            var e, t = a.window, n = a.value;
            ...
            var e = a.window, t = a.preview.trigger("change"), n = (a.value, r.find("#" + e.data("hash"))), i = function () {
        ...
        }, this.shortcuts = [{pattern: "space"}], this.support = {
            audio: {
            ...
            var s = this.options, l = this.window, d = this.preview;
            t = s.width > 0 ? parseInt(s.width) : 450, n = s.height > 0 ? parseInt(s.height) : 300, o.one("load", function () {
                i = o.getUI(), r = o.getUI("cwd"), l.appendTo("body").zIndex(100 + i.zIndex()), e(document).keydown(function (e) {
                    ...
                    a.opened() && (a.value ? d.trigger(e.Event("update", {file: a.value})) : l.trigger("close"))
        ...
        var n = ["image/jpeg", "image/png", "image/gif"], i = t.preview;
        e.each(navigator.mimeTypes, function (t, i) {
            var r = i.type;
            0 === r.indexOf("image/") && e.inArray(r, n) && n.push(r)
        }), i.bind("update", function (r) {
            var a, o = r.file;
            -1 !== e.inArray(o.mime, n) && (r.stopImmediatePropagation(), a = e("<img/>").hide().appendTo(i).load(function () {
                setTimeout(function () {
                    var e = (a.width() / a.height()).toFixed(2);
                    i.bind("changesize", function () {
                        var t, n, r = parseInt(i.width()), o = parseInt(i.height());
        ...
        var n = ["text/html", "application/xhtml+xml"], i = t.preview, r = t.fm;
        i.bind("update", function (a) {
            var o, s = a.file;
            -1 !== e.inArray(s.mime, n) && (a.stopImmediatePropagation(), i.one("change", function () {
                "pending" == o.state() && o.reject()
            }), o = r.request({
                data: {cmd: "get", target: s.hash, current: s.phash},
                preventDefault: !0
            }).done(function (n) {
        ...
        var n = t.fm, i = n.res("mimes", "text"), r = t.preview;
        r.bind("update", function (a) {
            var o, s = a.file, l = s.mime;
            (0 === l.indexOf("text/") || -1 !== e.inArray(l, i)) && (a.stopImmediatePropagation(), r.one("change", function () {
                "pending" == o.state() && o.reject()
            }), o = n.request({data: {cmd: "get", target: s.hash}, preventDefault: !0}).done(function (i) {
        ...
        var n = t.fm, i = "application/pdf", r = t.preview, a = !1;
        ...
        var n = t.fm, i = "application/x-shockwave-flash", r = t.preview, a = !1;
        ...
        e.each(navigator.plugins, function (t, n) {
            ...
            var o, s = a.file, l = s.mime;
            -1 !== e.inArray(s.mime, r) && (a.stopImmediatePropagation(), (o = 0 === l.indexOf("video/")) && t.hideinfo(), n = e('<embed src="' + t.fm.url(s.hash) + '" type="' + l + '" class="elfinder-quicklook-preview-' + (o ? "video" : "audio") + '"/>').appendTo(i))
        }).bind("change", function () {
            n && n.parent().length && (n.remove(), n = null)
        })
    }], elFinder.prototype.commands.reload = function () {
        this.alwaysEnabled = !0, this.updateOnSelect = !0, this.shortcuts = [{pattern: "ctrl+shift+r f5"}], this.getstate = function () {
            return 0
        }, this.exec = function () {
            var e = this.fm, t = e.sync(), n = setTimeout(function () {
                e.notify({type: "reload", cnt: 1, hideCnt: !0}), t.always(function () {
                    e.notify({type: "reload", cnt: -1})
                })
            }, e.notifyDelay);
        ...
        this.shortcuts = [{pattern: "f2" + ("mac" == this.fm.OS ? " enter" : "")}], this.getstate = function () {
            ...
            var t = this.fm, n = t.getUI("cwd"), i = t.selected(), r = i.length, a = t.file(i.shift()), o = ".elfinder-cwd-filename", s = e.Deferred().fail(function (e) {
                var i = l.parent(), r = t.escape(a.name);
                ...
                if (i.length) {
                    ...
                    i.html(t.escape(n)), t.lockfiles({files: [a.hash]}), t.request({
                        data: {
                            cmd: "rename",
                            target: a.hash,
                            name: n
                        ...
                        t.unlockfiles({files: [a.hash]})
                    })
                }
            }), d = n.find("#" + a.hash).find(o).empty().append(l.val(a.name)), c = l.val().replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/gi, "");
        ...
        this.updateOnSelect = !1, this.getstate = function () {
            ...
            var n, i, r = this.fm, a = this.files(t), o = e.Deferred(), s = function (t, n) {
                var i = e('<div class="elfinder-dialog-resize"/>'), a = '<input type="text" size="5"/>', s = '<div class="elfinder-resize-row"/>', l = '<div class="elfinder-resize-label"/>', d = e('<div class="elfinder-resize-control"/>'), c = e('<div class="elfinder-resize-preview"/>'), p = e('<div class="elfinder-resize-spinner">' + r.i18n("ntfloadimg") + "</div>"), u = e('<div class="elfinder-resize-handle"/>'), h = e('<div class="elfinder-resize-handle"/>'), f = e('<div class="elfinder-resize-uiresize"/>'), m = e('<div class="elfinder-resize-uicrop"/>'), g = '<div class="ui-widget-content ui-corner-all elfinder-buttonset"/>', v = '<div class="ui-state-default elfinder-button"/>', b = '<span class="ui-widget-content elfinder-toolbar-button-separator"/>', y = e('<div class="elfinder-resize-rotate"/>'), w = e(v).attr("title", r.i18n("rotate-cw")).append(e('<span class="elfinder-button-icon elfinder-button-icon-rotate-l"/>').click(function () {
                    W -= 90, Q.update(W)
                })), x = e(v).attr("title", r.i18n("rotate-ccw")).append(e('<span class="elfinder-button-icon elfinder-button-icon-rotate-r"/>').click(function () {
                    W += 90, Q.update(W)
                })), k = e("<span />"), C = e('<div class="ui-state-default ui-corner-all elfinder-resize-reset"><span class="ui-icon ui-icon-arrowreturnthick-1-w"/></div>'), I = e('<div class="elfinder-resize-type"/>').append('<input type="radio" name="type" id="' + n + '-resize" value="resize" checked="checked" /><label for="' + n + '-resize">' + r.i18n("resize") + "</label>").append('<input type="radio" name="type" id="' + n + '-crop" value="crop" /><label for="' + n + '-crop">' + r.i18n("crop") + "</label>").append('<input type="radio" name="type" id="' + n + '-rotate" value="rotate" /><label for="' + n + '-rotate">' + r.i18n("rotate") + "</label>"), F = e("input", I).attr("disabled", "disabled").change(function () {
                    var t = e("input:checked", I).val();
                    X(), et(!0), tt(!0), nt(!0), "resize" == t ? (f.show(), y.hide(), m.hide(), et()) : "crop" == t ? (y.hide(), f.hide(), m.show(), tt()) : "rotate" == t && (f.hide(), m.hide(), y.show(), nt())
                }), T = e('<input type="checkbox" checked="checked"/>').change(function () {
                    H = !!T.prop("checked"), Y.fixHeight(), et(!0), et()
                }), z = e(a).change(function () {
                    var e = parseInt(z.val()), t = parseInt(H ? Math.round(e / j) : P.val());
                    e > 0 && t > 0 && (Y.updateView(e, t), P.val(t))
                }), P = e(a).change(function () {
                    var e = parseInt(P.val()), t = parseInt(H ? Math.round(e * j) : z.val());
                    t > 0 && e > 0 && (Y.updateView(t, e), z.val(t))
                ...
                }), j = 1, U = 1, R = 0, q = 0, H = !0, L = 0, N = 0, _ = 0, V = 0, W = 0, B = e("<img/>").load(function () {
                    p.remove(), R = B.width(), q = B.height(), j = R / q, Y.updateView(R, q), u.append(B.show()).show(), z.val(R), P.val(q);
                    var t = Math.min(L, N) / Math.sqrt(Math.pow(R, 2) + Math.pow(q, 2));
                    _ = R * t, V = q * t, F.button("enable"), d.find("input,select").removeAttr("disabled").filter(":text").keydown(function (t) {
                        var n, i = t.keyCode;
                        return t.stopPropagation(), i >= 37 && 40 >= i || i == e.ui.keyCode.BACKSPACE || i == e.ui.keyCode.DELETE || 65 == i && (t.ctrlKey || t.metaKey) || 27 == i ? void 0 : (9 == i && (n = e(this).parent()[t.shiftKey ? "prev" : "next"](".elfinder-resize-row").children(":text"), n.length ? n.focus() : e(this).parent().parent().find(":text:" + (t.shiftKey ? "last" : "first")).focus()), 13 == i ? void r.confirm({
                            title: e("input:checked", I).val(),
                            text: "confirmReq",
                            accept: {
                        ...
                        }) : void(i >= 48 && 57 >= i || i >= 96 && 105 >= i || t.preventDefault()))
                    }).filter(":first").focus(), et(), C.hover(function () {
                        C.toggleClass("ui-state-hover")
                    }).click(X)
                }).error(function () {
                    p.text("Unable to load image").css("background", "transparent")
                }), K = e("<div/>"), G = e("<img/>"), $ = e("<div/>"), J = e("<img/>"), X = function () {
                    z.val(R), P.val(q), Y.updateView(R, q)
                }, Y = {
                    update: function () {
                        z.val(Math.round(B.width() / U)), P.val(Math.round(B.height() / U))
                    }, updateView: function (e, t) {
                        e > L || t > N ? e / L > t / N ? (U = L / e, B.width(L).height(Math.ceil(t * U))) : (U = N / t, B.height(N).width(Math.ceil(e * U))) : B.width(e).height(t), U = B.width() / e, k.text("1 : " + (1 / U).toFixed(2)), Y.updateHandle()
                    }, updateHandle: function () {
                        u.width(B.width()).height(B.height())
                    }, fixWidth: function () {
                        var e, t;
                        H && (t = P.val(), t = Math.round(t * j), Y.updateView(e, t), z.val(e))
                    }, fixHeight: function () {
                        var e, t;
                        H && (e = z.val(), t = Math.round(e / j), Y.updateView(e, t), P.val(t))
                    }
                }, Z = {
                    update: function () {
                        D.val(Math.round((h.data("w") || h.width()) / U)), M.val(Math.round((h.data("h") || h.height()) / U)), A.val(Math.round(((h.data("x") || h.offset().left) - G.offset().left) / U)), O.val(Math.round(((h.data("y") || h.offset().top) - G.offset().top) / U))
                    }, updateView: function () {
                        var e = parseInt(A.val()) * U + G.offset().left, t = parseInt(O.val()) * U + G.offset().top, n = D.val() * U, i = M.val() * U;
                        h.data({
                            x: e,
                            y: t,
                            w: n,
                            h: i
                        }), h.width(Math.round(n)), h.height(Math.round(i)), $.width(h.width()), $.height(h.height()), h.offset({
                            left: Math.round(e),
                            top: Math.round(t)
                        })
                    }, resize_update: function () {
                        h.data({w: null, h: null}), Z.update(), $.width(h.width()), $.height(h.height())
                    }, drag_update: function () {
                        h.data({x: null, y: null}), Z.update()
                    }
                }, Q = {
                    mouseStartAngle: 0, imageStartAngle: 0, imageBeingRotated: !1, update: function (e, t) {
                        "undefined" == typeof e && (W = e = parseInt(S.val())), "undefined" == typeof t && (t = !0), !t || r.UA.Opera || r.UA.ltIE8 ? J.rotate(e) : J.animate({rotate: e + "deg"}), e %= 360, 0 > e && (e += 360), S.val(parseInt(e)), E.slider("value", S.val())
                    }, execute: function (e) {
                        if (Q.imageBeingRotated) {
                            var t = Q.getCenter(J), n = e.pageX - t[0], i = e.pageY - t[1], r = Math.atan2(i, n), a = r - Q.mouseStartAngle + Q.imageStartAngle;
                            return a = Math.round(180 * parseFloat(a) / Math.PI), e.shiftKey && (a = 15 * Math.round((a + 6) / 15)), J.rotate(a), a %= 360, 0 > a && (a += 360), S.val(a), E.slider("value", S.val()), !1
                        }
                    }, start: function (t) {
                        Q.imageBeingRotated = !0;
                        var n = Q.getCenter(J), i = t.pageX - n[0], r = t.pageY - n[1];
                        return Q.mouseStartAngle = Math.atan2(r, i), Q.imageStartAngle = parseFloat(J.rotate()) * Math.PI / 180, e(document).mousemove(Q.execute), !1
                    }, stop: function () {
                        ...
                        var e = J.rotate();
                        J.rotate(0);
                        var t = J.offset(), n = t.left + J.width() / 2, i = t.top + J.height() / 2;
                        return J.rotate(e), Array(n, i)
                    }
                }, et = function (t) {
                    ...
                    e.fn.draggable && e.fn.resizable && (t ? (h.filter(":ui-resizable").resizable("destroy"), h.filter(":ui-draggable").draggable("destroy"), K.hide()) : (G.width(B.width()).height(B.height()), $.width(B.width()).height(B.height()), h.width(G.width()).height(G.height()).offset(G.offset()).resizable({
                        containment: K,
                        ...
                        containment: G,
                        drag: Z.drag_update
                    }), K.show().width(B.width()).height(B.height()), Z.update()))
                }, nt = function (t) {
                    e.fn.draggable && e.fn.resizable && (t ? J.hide() : J.show().width(_).height(V).css("margin-top", (N - V) / 2 + "px").css("margin-left", (L - _) / 2 + "px"))
                }, it = function () {
                    var n, a, s, l, d, c = e("input:checked", I).val();
                    if ("resize" == c)n = parseInt(z.val()) || 0, a = parseInt(P.val()) || 0; else if ("crop" == c)n = parseInt(D.val()) || 0, a = parseInt(M.val()) || 0, s = parseInt(A.val()) || 0, l = parseInt(O.val()) || 0; else if ("rotate" == c) {
                ...
                J.mousedown(Q.start), e(document).mouseup(Q.stop), f.append(e(s).append(e(l).text(r.i18n("width"))).append(z).append(C)).append(e(s).append(e(l).text(r.i18n("height"))).append(P)).append(e(s).append(e("<label/>").text(r.i18n("aspectRatio")).prepend(T))).append(e(s).append(r.i18n("scale") + " ").append(k)), m.append(e(s).append(e(l).text("X")).append(A)).append(e(s).append(e(l).text("Y")).append(O)).append(e(s).append(e(l).text(r.i18n("width"))).append(D)).append(e(s).append(e(l).text(r.i18n("height"))).append(M)), y.append(e(s).append(e(l).text(r.i18n("rotate"))).append(e('<div style="float:left; width: 130px;">').append(e('<div style="float:left;">').append(S).append(e("<span/>").text(r.i18n("degree")))).append(e(g).append(w).append(e(b)).append(x))).append(E)), i.append(I), d.append(e(s)).append(f).append(m.hide()).append(y.hide()).find("input,select").attr("disabled", "disabled"), u.append('<div class="' + at + " " + at + '-top"/>').append('<div class="' + at + " " + at + '-bottom"/>').append('<div class="' + ot + " " + ot + '-left"/>').append('<div class="' + ot + " " + ot + '-right"/>').append('<div class="' + st + " " + st + '-e"/>').append('<div class="' + st + " " + st + '-se"/>').append('<div class="' + st + " " + st + '-s"/>'), c.append(p).append(u.hide()).append(B.hide()), h.css("position", "absolute").append('<div class="' + at + " " + at + '-top"/>').append('<div class="' + at + " " + at + '-bottom"/>').append('<div class="' + ot + " " + ot + '-left"/>').append('<div class="' + ot + " " + ot + '-right"/>').append('<div class="' + st + " " + st + '-n"/>').append('<div class="' + st + " " + st + '-e"/>').append('<div class="' + st + " " + st + '-s"/>').append('<div class="' + st + " " + st + '-w"/>').append('<div class="' + st + " " + st + '-ne"/>').append('<div class="' + st + " " + st + '-se"/>').append('<div class="' + st + " " + st + '-sw"/>').append('<div class="' + st + " " + st + '-nw"/>'), c.append(K.css("position", "absolute").hide().append(G).append(h.append($))), c.append(J.hide()), c.css("overflow", "hidden"), i.append(c).append(d), rt[r.i18n("btnApply")] = it, rt[r.i18n("btnCancel")] = function () {
                ...
                }).attr("id", n), r.UA.ltIE8 && e(".elfinder-dialog").css("filter", ""), C.css("left", z.position().left + z.width() + 12), $.css({
                    opacity: .2,
                    ...
                    opacity: .5,
                    "border-color": "#000"
                }), J.css("cursor", "pointer"), I.buttonset(), L = c.width() - (u.outerWidth() - u.width()), N = c.height() - (u.outerHeight() - u.height()), B.attr("src", lt + (-1 === lt.indexOf("?") ? "?" : "&") + "_=" + Math.random()), G.attr("src", B.attr("src")), J.attr("src", B.attr("src"))
            };
        ...
        var t = function (e, t) {
            var n = 0;
            for (n in t)if ("undefined" != typeof e[t[n]])return t[n];
            return e[t[n]] = "", t[n]
        };
        if (e.cssHooks.rotate = {
            ...
            var n = function (e) {
                ...
                var u = parseInt(e.style.width || e.width || 0), h = parseInt(e.style.height || e.height || 0), d = l * Math.PI / 180, f = Math.abs(Math.cos(d)), m = Math.abs(Math.sin(d)), g = (u - (u * f + h * m)) / 2, v = (h - (u * m + h * f)) / 2;
        ...
        this.shortcuts = [{pattern: "delete ctrl+backspace"}], this.getstate = function (t) {
            var n = this.fm;
            ...
            var n = this, i = this.fm, r = e.Deferred().fail(function (e) {
                e && i.error(e)
            }), a = this.files(t), o = a.length, s = i.cwd().hash, l = !1;
            return !o || this._disabled ? r.reject() : (e.each(a, function (e, t) {
                return t.phash ? t.locked ? !r.reject(["errLocked", t.name]) : void(t.hash == s && (l = i.root(t.hash))) : !r.reject(["errRm", t.name, "errPerm"])
            }), "pending" == r.state() && (a = this.hashes(t), i.confirm({
                title: n.title,
                text: "confirmRm",
                accept: {
                    label: "btnRm", callback: function () {
                        i.lockfiles({files: a}), i.request({
                            data: {cmd: "rm", targets: a},
                            notify: {type: "rm", cnt: o},
                            preventFail: !0
                        }).fail(function (e) {
                            r.reject(e)
                        }).done(function (e) {
        ...
        this.title = "Find files", this.options = {ui: "searchbutton"}, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.getstate = function () {
            ...
            var n = this.fm;
            return "string" == typeof t && t ? (n.trigger("searchstart", {query: t}), n.request({
                data: {
                    cmd: "search",
                    q: t
                }, notify: {type: "search", cnt: 1, hideCnt: !0}
            })) : (n.getUI("toolbar").find("." + n.res("class", "searchbtn") + " :text").focus(), e.Deferred().reject())
        }
    }, elFinder.prototype.commands.sort = function () {
        this.options = {ui: "sortbutton"}, this.getstate = function () {
            return 0
        }, this.exec = function (t, n) {
            var i = this.fm, n = e.extend({type: i.sortType, order: i.sortOrder, stick: i.sortStickFolders}, n);
        ...
        this.disableOnSearch = !0, this.updateOnSelect = !1, this.shortcuts = [{pattern: "ctrl+u"}], this.getstate = function () {
            ...
            var i, r, a, o, s, l = this.fm, d = function (e) {
            ...
            return this.disabled() ? e.Deferred().reject() : n && (n.input || n.files) ? l.upload(n) : (i = e.Deferred(), a = e('<input type="file" multiple="true"/>').change(function () {
                ...
                e.stopPropagation(), e.preventDefault(), d({files: e.dataTransfer.files})
            }, !1)), l.dialog(r, {title: this.title, modal: !0, resizable: !1, destroyOnClose: !0}), i)
        }
    }, elFinder.prototype.commands.view = function () {
        this.value = this.fm.viewType, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.options = {ui: "viewbutton"}, this.getstate = function () {
            return 0
        }, this.exec = function () {
