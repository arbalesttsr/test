...
class UserButton extends CWidget
{
    ...
    public function init()
    {
        ...
        if (isset($this->icon)) {
            if (strpos($this->icon, 'icon') === false)
                ...
                $this->label = '<i></i> ' . $this->label;
            $this->htmlOptions['class'] .= ' btn-icon glyphicons ' . $this->icon;
        }
    ...
    public function run()
    {
        ...
        if ($this->hasDropdown()) {
            $this->controller->widget('application.components.widgets.usertheme.UserDropdown', array(
    ...
    protected function createButton()
    {
        switch ($this->buttonType) {
            ...
            default:
                if (isset($this->url))
                    $this->htmlOptions['onclick'] = 'js:window.location.href = "' . $this->url . '";';
                return CHtml::htmlButton($this->label, $this->htmlOptions);
        }
    }
}
