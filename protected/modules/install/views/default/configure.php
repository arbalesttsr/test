...
<div class="form wide">
    ...
    <div class="row buttons">
        <label
            style="width:300px;"><?php echo $form->checkBox($model, 'installDemoData') ?><?php echo $model->getAttributeLabel('installDemoData') ?></label>
    </div>

    <div class="row buttons">
        <input type="submit" value="<?php echo Yii::t('InstallModule.core', 'Установить') ?>"
               onclick="this.disabled=true;this.value='Установка...';this.form.submit();">
    </div>
