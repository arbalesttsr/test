...
?>
    ...
    <div class="form">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model, 'gender', $model->getGenders(), array('prompt' => Yii::t('label', 'SELECT'))); ?>
...
?>
    ...
    <div class="form">
        ...
        <?php
        foreach (Yii::app()->db->getSchema()->getTable(ClientProfileAdditional::model()->tableName())->columns as $column) {
            ...
            switch ($fieldsConfig[$column->name]['fieldType']) {
                ...
                case 'dropDownList':
                    ...
                    if ($column->isForeignKey) {
                        //$requestedColumnName = ClientProfileAdditional::model()->getSecondColumn($column->name);
                        ...
                        $att_enum = ClientProfileAdditional::model()->getEnumValues();
...
<?php Yii::app()->clientScript->registerScript('datapicker-profile-update', '
    $("#ClientProfile_birthday").datepicker({
        //changeYear: true,
