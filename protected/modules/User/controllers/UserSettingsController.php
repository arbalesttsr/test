...
class UserSettingsController extends Controller
{
     ...
     * If creation is successful, the browser will be redirected to the 'view' page.
     */
    public function actionCreateHolidays()
    {
        $model = new Holidays();
        ...
        if (isset($_POST['Holidays'])) {
            ...
            if ($model->save())
                $this->redirect(array('holidaysAdmin'));
        }

        $this->render('_holiday_form', array(
            'model' => $model,
        ));
    }
     ...
     * @param integer $id the ID of the model to be updated
     */
    public function actionUpdateHolidays($id)
    {
     ...
     * @param integer $id the ID of the model to be deleted
     */
    public function actionDeleteHolidays($id)
    {
        $model = Holidays::model()->findByPk($id);
        $model->delete();
        // if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    /**
     * Holidays Admin action
     *
     */
    public function actionHolidaysAdmin()
    {
        ...
        $this->render('_holiday_admin', array(
            'model' => $model,
        ));
    }
