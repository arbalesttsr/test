 ...
 */
class ClientProfile extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('email, firstname, lastname, mobile', 'required'),
            array('subsidiary_id, department_id', 'numerical', 'integerOnly'=>true),
            array('patronymic, phone, mobile', 'length', 'max'=>45),
            array('firstname', 'match', 'pattern'=>'/^[a-zA-Z_.\-]{2,45}/i', 'message'=>Yii::t('UserModule.t','FIRSTNAMEMESSAGE')),
            array('lastname', 'match', 'pattern'=>'/^[a-zA-Z_.\-]{2,45}/i', 'message'=>Yii::t('UserModule.t','LASTNAMEMESSAGE')),
            array('about', 'length', 'max'=>255),
            array('email', 'length', 'max'=>100),
            array('idnp', 'match', 'pattern'=>'/^[0-9_.\-]{8,13}/i', 'message'=>Yii::t('UserModule.t','IDNPMESSAGE')),
            //array('email', 'email'),
    ...
    public function relations()
    {
        ...
        return array(
            'user' => array(self::BELONGS_TO, 'Client', 'user_id'),
