...
/**
 * ApLinkPager class file.
 *
 * An alphanumeric link pager. Strongly based on Qiang Xues {@link CLinkPager} from yiiframework.
 *
 * @author Jascha Koch
...
class ApLinkPager extends CBasePager
{
    ...
    {
        if ($url === null)
            $url = CHtml::asset(dirname(__FILE__) . '/assets/aplinkpager.css');
