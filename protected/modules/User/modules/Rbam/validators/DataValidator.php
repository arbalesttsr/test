...
class DataValidator extends CValidator
{
    ...
    {
        if (!empty($model->bizrule) && strpos($model->bizrule, '$data') !== false && empty($model->data))
            $model->addError('data', Yii::t('RbamModule.validation', '97897987987cannot be empty if referred to in the business rule'));
    }
}
