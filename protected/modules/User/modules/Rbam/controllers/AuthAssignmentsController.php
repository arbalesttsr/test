...
/**
 * AuthAssignmentsController class file.
...
class AuthAssignmentsController extends RbamController
{
    ...
    {
        Yii::import('User.modules.Rbam.extensions.alphapager.ApPagination');
        Yii::import('User.modules.Rbam.extensions.alphapager.ApActiveDataProvider');
    ...
    {
        Yii::import('User.modules.Rbam.extensions.alphapager.ApPagination');
        Yii::import('User.modules.Rbam.extensions.alphapager.ApArrayDataProvider');
        ...
        $this->pageTitle = $this->_pageTitle($this->action->id, array('{user}' => $user->username));
    ...
    public function actionRevoke($role, $uid)
    {
        ...
        if (is_null($assignment))
            throw new CHttpException(404, Yii::t('RbamModule.rbam', '"{user}::{role}" assignment not found.', array('{user}' => $user->username, '{role}' => $role)));
